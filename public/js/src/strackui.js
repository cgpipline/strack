...
(function ($) {
    ...
    function _35(e) {
        ...
        _38.css({
            left: e.data.left,
            top: e.data.top - $(_38.parent()[0]).scrollTop()
        });
...
(function ($) {
    function _a1(_a2) {
        ...
        $('<div class="pagination-selected"></div>').appendTo(_a5);
    ...
    function _b2(_b3, _b4) {
        ...
        var setpsize = isNaN(_b6.pageSize) ? _b6.total : _b6.pageSize;
        _ba = _ba.replace(/{from}/, _b6.total == 0 ? 0 : setpsize * (_b6.pageNumber - 1) + 1);
        _ba = _ba.replace(/{to}/, Math.min(setpsize * _b6.pageNumber, _b6.total));
...
(function ($) {
    ...
    $.messager = {
        ...
        prompt: function (_2b4, msg, fn) {
            ...
            opts = $.extend({}, $.messager.defaults, {
                content: '<div class="messager-icon messager-question"></div>' + "<div>" + opts.msg + "</div>" + "<br/>" + '<div style="clear:both;"/>' + '<div><input class="messager-input" type="password"/></div>'
            }, opts);
            if (!opts.buttons) {
                opts.buttons = [{
                    text: opts.ok,
...
(function ($) {
    ...
    function init(_3f4) {
        ...
        $(_3f4).addClass("menu-top st-menu");
        ...
        $.data(_3f4, "menu").options.afterRender.call(_3f4);
    }
    ...
    function _41b(_41c, _41d) {
        ...
        if (_41d.parent) {
            if (!_41d.parent.submenu) {
                var _41e = $('<div class="menu st-menu"><div class="menu-line"></div></div>').appendTo("body");
                _41e.hide();
...
(function ($) {
    ...
    function _456(_457, _458) {
        ...
        _45a.find(".switchbutton-handle")._outerWidth(_45c - 4)._outerHeight(h - 6).css({
            marginLeft: -_45c / 2 + "px"
        });
        _45a.find(".switchbutton-on").css({
            width: w - _45c / 2 + 11 + "px",
    ...
    function _45e(_466, _467, _468) {
        ...
        var _off_bnt = _46a.find(".switchbutton-off");
        var _46b = _46a.find(".switchbutton-on");
        var handle = _46a.find(".switchbutton-handle");
        var _46c = opts.reversed ? opts.checked ? opts.marginWidth + 22 : 0 : opts.checked ? 0 : opts.marginWidth + 22;
        var dir = _46b.css("float").toLowerCase();
        var css = {};
        css["margin-" + dir] = -_46c + "px";

        var h_left = '', on_color = '', on_text = '', off_text = '';
        ...
        if (_467) {
            ...
            on_color = '#bfbfbf';
            on_text = '';
            off_text = opts.offText;
        }

        _46b.animate({"background-color": on_color}).html(on_text);
        _off_bnt.animate({"background-color": on_color}).html(off_text);

        handle.animate({
            'margin-left': h_left
        }, 400);

        _468 ? _46a.animate(css, 399) : _46a.css(css);
    ...
    $.fn.switchbutton.methods = {
        ...
        toggle : function (jq, _47e) {
            return jq.each(function () {
                $(this).val(_47e);
                $.data(this, "switchbutton").switchbutton.find(".switchbutton-value").val(_47e);
                var checked = _47e === 1? true: false;
                _45e(this, checked);
            });
        }
    };
...
(function ($) {
    ...
    function _4bb(_4bc) {
        ...
        if (bb.length) {
            ...
            for (var i = 0; i < bb.length; i++) {
                if (opts.isSearch) {
                    bc.append('<a href="javascript:void(0)" class="textbox-icon" icon-index="' + i + '" tabindex="-1"><i class="' + bb[i].iconCls + '"></i></a>');
                } else {
        ...
        if (opts.buttonFilter) {
            $('<a href="javascript:void(0)" class="search-filter-field" onclick="Strack.toggle_filter_field(this)" data-maindom="' + opts.filterBar.main_dom + '" data-bardom="' + opts.filterBar.bar_dom + '"><i class="filter icon icon-left"></i>' + StrackLang["Field"] + '</a>').prependTo(tb);
            $('<a href="javascript:void(0)" class="search-filter-button" onclick="Strack.toggle_filter(this)" data-maindom="' + opts.filterBar.main_dom + '" data-bardom="' + opts.filterBar.bar_dom + '"><i class="icon-uniF141"></i></a>').appendTo(tb);
        }
    ...
    function _4c2(_4c3, _4c4) {
        ...
        _4c9.css({
            ...
            right: opts.iconAlign == "right" ? opts.buttonAlign == "right" ? btn._outerWidth() : opts.buttonRightVal : ""
        });
        _4ca.css({
            width: opts.iconWidth + "px",
            height: tb.height() + "px",
            'line-height': tb.height() + "px"
        });
        if (opts.buttonFilter) {
            _4c8.css({
        ...
        if (opts.buttonFilter) {
            _4c8._outerWidth(tb.width() - _4ca.length * opts.iconWidth - btn._outerWidth() - 110);
        } else {
...
(function ($) {
    function _506(_507) {
        ...
        if(opts.buttonRadius){
            _508.searchbox.css("border-radius", "500em");
        }
        _50d(_50b);
    ...
    $.fn.searchbox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "searchbox").options, {
                ...
                disabled: opts.disabled,
                readonly: opts.readonly,
                showFilterField: opts.showFilterField
            });
        },
        menu: function (jq) {
...
(function ($) {
    ...
    $.fn.form.defaults = {
        fieldTypes: ["combobox", "combotree", "combogrid", "datetimebox", "datebox", "combo", "datetimespinner", "timespinner", "numberspinner", "spinner", "slider", "searchbox", 'tagbox', "numberbox", "textbox", "switchbutton"],
        novalidate: false,
        ajax: true,
        url: null,
        queryParams: {},
...
(function ($) {
    ...
    function _5a8(_5a9) {
        ...
        var td_h = $(_5a9).closest('.datagrid-row').height();
    ...
    $.fn.timespinner.defaults = $.extend({}, $.fn.spinner.defaults, {
        ...
        formatter: function (date) {
            ...
            if(opts.limit === 'number'){
                var t1 = parseInt(date[0]) > 99 ? 99 : parseInt(date[0]) < 0 ? 0 : parseInt(date[0]);
                var t2 = parseInt(date[1]) > 59 ? 59 : parseInt(date[1]) < 0 ? 0 : parseInt(date[1]);
                return [_5bf(t1), _5bf(t2)].join(opts.separator);
            }
...
(function ($) {
    ...
    function _5e6(_5e7) {
        ...
        if (opts.adaptive) {
            var d_offset = $(opts.adaptive.dom).offset();
            var fwidth = $('#' + opts.id).closest('.entity-datalist').next('.datagrid-filter').width();
            ...
            _5ea = window.innerHeight - d_offset.top - 2 - opts.adaptive.exth;
    ...
    function _5f7(_5f8, _5f9, _5fa) {
        ...
        function _5fb(trs1, trs2, _5f8) {
            var $cdata = $(_5f8),
                $parent = $cdata.parent();//限制下在当前datagrid下改变

            if (opts.rowheight > 0 && !opts.differhigh) {
                $parent.find('.datagrid-row')
                    .css("height", opts.rowheight);
            } else if (opts.rowheight > 0 && opts.differhigh && trs1.length >0) {
                var col_r = trs1[0].id.split("-")[2];
                $parent.find('.datagrid-row').css("height", opts.rowheight);
                trs2.each(function () {
                    var $this = $(this);
                    $parent.find("#datagrid-row-" + col_r + "-1-" + $this.attr("datagrid-row-index")).css("height", $this.height());
                });
            } else {
    ...
    function _60b(_60c, _60d) {
        ...
        if(_60d.isKanban){
            // 看板视图
            view.prepend('<div class="datagrid-view-kanban"></div>');
            view_kanban = view.children("div.datagrid-view-kanban");
        }
    ...
    function _614(_615) {
        ...
        if (opts.pagination) {
            ...
            _61c.pagination({
                ...
                layout: opts.pageLayout,
                onSelectPage: function (_61d, _61e) {
                    //一页显示所有
                    _61e = isNaN(_61e) ? "All" : _61e;
            ...
            if (opts.sortConfig && !opts.isKanban) {
                // 看板视图不需要应用排序
                var $grid_sort = $(_615).closest(".entity-datalist").find(".grid_sort");

                //存在保存的实体排序
                Strack.init_sort_grid_icon($(_615), $grid_sort, opts.sortConfig);
            }
        }
        ...
        function _61a(_61f, _620, _621) {
            ...
            if(_620.length === 2){
                // 两层表头
                _620[0].forEach(function (val) {
                   if(val && val["step"] === "yes" && val["hidden_status"] !== "yes"){
                       Strack.G.gridFirstColMap[val["but"]] = val["colspan"] > 1? true: false;
                   }
                });
            }
            for (var i = 0; i < _620.length; i++) {
                ...
                for (var j = 0; j < cols.length; j++) {
                    ...
                    //新增class方便控制表头
                    if (col.class) {
                        attr += 'class="' + col.class + ' clohide" ';
                    }
                    //新增class方便控制表头 增加背景颜色
                    if (col.cbd) {
                        attr += 'class="' + col.cbd + '" ';
                    }
                    if (col.bgc) {
                        attr += 'style=" background-color:#' + col.bgc + ';border-color:#' + col.bgc + ';border-style: solid;border-width: 0px 2px;" ';
                    }
                    //新增class方便控制表头 增加边框颜色
                    if (col.bdc) {
                        switch (col.cbd ){
                            case "colboth" :
                                if(Strack.G.gridFirstColMap[col["belong"]]){
                                    attr += 'style="border-color:#DDD #DDD #DDD #' + col.bdc + ';border-style: dotted dotted dotted solid;border-width: 0px 1px 1px 3px"';
                                }else {
                                    attr += 'style=" border-color:#' + col.bdc + '"';
                                }
                                break;
                            default:
                                attr += 'style=" border-color:#' + col.bdc + '"';
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.field) {
                            td.attr("field", col.field);
                            var fdown = "", ncl = "", bfd="", ckd = "", fdd = "";
                            if (opts.HeaderField && col.col_type !== 'bnt') {
                                fdown = '<a href="javascript:;" id="ickn_' + col.field + '" class="cell-excel-down" onclick="Strack.show_excel_check_fields(this,event)" data-field="' + col.field + '"><i class="dropdown icon"></i></a>';
                                ncl = "cell-excel";
                                ckd = '<div id="cell_ckt_' + col.field + '" class="cell-excel-ck">' + StrackLang["Non_Mapping_Field"] + '</div>';
                            }
                            if(opts.headerAddCheckbox && opts.treeField !== col.field){
                                bfd = '<a href="javascript:;" onclick="Strack.rule_grid_header_checkbox(this)" id="rule_header_checkbox_'+col.field+'" class="dg-rule-checkbox" style="margin-right: 5px" data-pos="header" data-field="'+col.field+'"><div class="tree-checkbox tree-checkbox0"></div></a>';
                            }
                            //是否允许冻结表头
                            if (col.frozen === "frozen") {
                                fdd = "<a href='javascript:;' class='cols_frozen no-move' onclick='Strack.frozen_col(this,event)' data-index='" + col.findex + "'><i class='icon-uniF023 icon-right'></i></a>";
                            } else if (col.frozen === "nofrozen") {
                                fdd = "<a href='javascript:;' class='cols_frozen no-move' onclick='Strack.frozen_col(this,event)' data-index='" + col.findex + "'><i class='icon-uniF09C icon-right'></i></a>";
                            }
                            //是否允许拖拽
                            if (col.drag) {
                                td.addClass("drag-yes");
                            }
                            td.attr("row_index", 1);

                            td.append('<div class="datagrid-cell">'+bfd+'<span class="' + ncl + '"></span><a href="javascript:;" class="datagrid-sort-icon no-move icon-left" onclick="Strack.sort_grid_item(this)" data-field="' + col.field + '" data-grid="' + opts.id + '" style="font-size: 12px;"></a>' + fdown + fdd + '</div>' + ckd);
                            td.find("span:first").html(col.title);
                            var cell = td.find("div.datagrid-cell"),
                                pos = _5cc(_622, col.field);
                            if (pos >= 0) {
                            ...
                            if (col.but) {
                                td.addClass("drag-yes");
                                td.attr("fname", col.fname)
                                    .attr("field", col.fname)
                                    .attr("row_index", 0);
                                var step_bnt_icon = '';
                                if (col.colspan > 1) {
                                    showcol = 'showcol';
                                    step_bnt_icon = "icon-uniF100";
                                }else {
                                    step_bnt_icon = "icon-uniF101";
                                }
                                td.find('div').prepend('<a class="colswitch ' + showcol + '" href="javascript:;" onclick="Strack.show_or_hide_grid_step(this)" data-grid="'+opts.id+'" data-color="' + col.bgc + '" data-col="' + col.but + '" data-firstfield="' + col.first_field + '" data-fieldlist="' + col.field_list + '"><i class="'+step_bnt_icon+'"></i></a>');
                            }
                        }
                    }
                    if (col.hidden) {
        ...
        _62e.each(function () {
            $(this).resizable({
                ...
                onStopResize: function (e) {
                    ...
                    $(_62a).datagrid("highlightViewSave");
            ...
            if(!(e.ctrlKey || e.shiftKey) && e.button === 0){
                ...
                if (opts.DragSelect) {
                    ...
                    $(document).on("mousemove", function (e) {
                        var $row = $(e.target).closest(".datagrid-row"),
                        ...
                        if (cposition < e.clientY) {
                            cdirection = 'down';
                        } else if (cposition > e.clientY) {
                            cdirection = 'up';
                        }
                        switch (direction) {
                            case "down":
                                if (direction === 'down' && cdirection === 'down') {
                                    $(_63e).datagrid("selectRow", index);
                                } else if (e.clientY < origin) {
                                    $(_63e).datagrid("selectRow", index);
                                    origin = e.clientY;
                                } else {
                                    $(_63e).datagrid("unselectRow", index);
                                }
                                break;
                            case "up":
                                if (direction === 'up' && cdirection === 'up') {
                                    $(_63e).datagrid("selectRow", index);
                                } else if (e.clientY > origin) {
                                    $(_63e).datagrid("selectRow", index);
                                    origin = e.clientY;
    ...
    function _63d(e) {
        ...
        if (tt.parent().hasClass("datagrid-cell-check")) {
            ...
            if (td.length) {
                ...
                opts.onClickCell.call(_63e, _63f, _642, row[_642], e.target);
                //判断文本内容是否超过显示框
                if (e.target.tagName == 'TD' || $(e.target).closest(".datagrid-cell").length > 0) {
                    var target, td_row;
                    if (e.target.tagName == 'TD') {
                        target = $(e.target).find(".datagrid-cell");
                        td_row = $(e.target);
                    } else {
                        target = $(e.target).closest(".datagrid-cell");
                        td_row = $(e.target).closest("td");
                    }
                    if (Math.round(target.prop('scrollWidth')) > Math.round(target.outerWidth())) {
                        layer.tips([
                            '<div class="layui-table-tips-main" style="margin-top: -' + (td_row.height() + 12) + 'px;' + function () {
                                return 'padding: 4px 15px;';
                            }() + '">'
                            , target.html()
                            , '</div>'
                            , '<i class="icon-uniE6DF layui-table-tips-c"></i>'
                        ].join(''), td_row[0], {
                            tips: [3, '']
                            , time: -1
                            , anim: -1
                            ...
                            , success: function (layero, index) {
                                layero.css('width', target.outerWidth());
    ...
    function _64b(e) {
        ...
        if (tr) {
            ...
            // 是否允许显示datagrid 右键菜单
            if (opts.showContextMenu) {
                e.preventDefault();
                grid_clipboard(e.target);
                var top = e.pageY;
                var notice_h = $(".globel-top-notice").height();
                if(notice_h > 0){
                    top = top - notice_h - 10;
                }
                $('#' + opts.contextMenuData.id).menu("show", {
                    left: e.pageX,
                    top: top
                });
            }
    ...
    function _65b(_694, data) {
        ...
        if (opts.view.onAfterRender) {
            // 初始化媒体预览
            Strack.init_other_thumb_media('grid');
    ...
    function _643(_6b6, _6b7, _6b8) {
        ...
        //统计当前页面已经选中个数
        $(_6b6).datagrid("showSelectedNumber");
    ...
    function _6bf(_6c0, _6c1) {
        ...
        //统计当前页面已经选中个数
        $(_6c0).datagrid("showSelectedNumber");
    ...
    function _6ba(_6c6, _6c7) {
        ...
        //统计当前页面已经选中个数
        $(_6c6).datagrid("showSelectedNumber");
    ...
    function _6db(_6dc, _6dd) {
        ...
        tr.find("div.datagrid-editable").each(function () {
            ...
            var ed = $.data(this, "datagrid.editor");
            //获取映射字段值, 赋值根据当前字段映射值来获取
            if(ed){
                ed.actions.setValue(ed.target, row[opts.columnsFieldConfig[_6df]["field_map"]]);
            }
        });
        _6e0(_6dc, _6dd);
    ...
    function _6e1(_6e2, _6e3, _6e4) {
        ...
        if (!_6e4) {
            ...
            tr.find("div.datagrid-editable").each(function () {
                ...
                if(opts.columnsFieldConfig[_6ea]['editor'] === "task_repeat"){
                    can_update = true;
                    _6ec = $(this).find('.field_edit_item').val();
                    ...
                    //获取当前控件数据
                    _6ec = ed.actions.getValue(ed.target);
                }
                ...
                var old_val = '';
                if(row.hasOwnProperty(opts.columnsFieldConfig[_6ea]["field_map"]) && row[opts.columnsFieldConfig[_6ea]["field_map"]]){
                    if(row[opts.columnsFieldConfig[_6ea]["field_map"]].hasOwnProperty('rows')){
                        var val_list = [];
                        row[opts.columnsFieldConfig[_6ea]["field_map"]]['rows'].forEach(function (val) {
                            val_list.push(val["id"]);
                        });
                        old_val = val_list.join(",");
                    }else {
                        old_val = row[opts.columnsFieldConfig[_6ea]["field_map"]];
                    }
                }

                if (old_val != _6ec || can_update) {
                    ...
                    var fopts = opts.columnsFieldConfig[_6ea];
                    if (opts.cellUpdateMode === "auto") {

                        if (fopts["editor"] === "checkbox" && !_6ec) {
                            _6ec = "off";
                        }
                        var primary_value = "";

                        if (fopts["field_type"] === "custom"){
                            primary_value = row["id"];
                        }else{
                            primary_value = row[fopts["primary"]];
                        }

                        //自动直接更新当前字段
                        var td_dom_id = $(this).closest('td[field]').attr("id");
                        var widget_param = {
                            dom : td_dom_id,
                            editor: 'common',
                            original_field: fopts["field_value_map"],
                            other_param : other_param
                        };

                        //自动更新
                        var module_id = fopts["module_id"] ? fopts["module_id"] : opts.moduleId;
                        f_updata = {
                            data_source: fopts["data_source"],
                            primary: fopts["primary"],
                            primary_value: primary_value,
                            module: fopts["module"],
                            table: fopts["table"],
                            original_field: fopts["fields"],
                            field: fopts["field_value_map"],
                            field_type: fopts["field_type"],
                            module_id: module_id,
                            module_code: fopts["module_code"],
                            project_id: opts.projectId,
                            variable_id: fopts["variable_id"],
                            editor: fopts["editor"],
                            val: _6ec,
                        ...
                        //脏数据处理
                        var in_key = _6ea + '_' + _6e3;
                        if ($.inArray(in_key, opts.gridDirtyData["list"]) < 0) {
                            opts.gridDirtyData["list"].push(in_key);
                        }
                        opts.gridDirtyData["value"][in_key] = {
                            primary: row[opts.columnsFieldConfig[_6ea]["primary"]],
                            field: _6ea,
                            value: _6ec
                        };
                    }
    ...
    function _6f2(_6f3, _6f4) {
        ...
        for (var i = 0; i < _6f5.length; i++) {
            if (_6f5[i] && _6f5[i].field == _6f4.field) {
                return _6f5[i];
            }
        }
        return null;
    ...
    function _6ed(_6fe, _6ff) {
        ...
        tr.children("td").each(function () {
            ...
            if (cell.length) {
                ...
                var field = $(cell.prevObject[0]).attr('field');
                switch (opts.columnsFieldConfig[field]['editor']) {
                    case 'task_repeat':
                        Strack.remove_task_repeat_editor();
                        cell.html($(cell[0]).find('.field_edit_item').val());
                        break;
                    default:
                        var ed = $.data(cell[0], "datagrid.editor");
    ...
    //渲染grid必须组件
    function render_grid_entity(dg, opts) {
        if (opts.filterConfig.id) {

            //获取当前模块查询参数
            var $fmain = $('#' + opts.filterConfig.id);

            var page = opts.toolbarConfig.page,
                module_id = opts.moduleId,
                maindom = $fmain.attr("data-maindom"),
                bardom = $fmain.attr("data-bardom"),
                project_id = opts.projectId;

            //初始化过滤框
            if (opts.searchConfig.id && opts.authorityRules.filter.show === "yes") {
                var $search_box = $('#' + opts.searchConfig.id);

                if($search_box.hasClass("searchbox-f")){
                    // 销毁之前
                    $("#" + maindom).find(".search-filter-field").removeClass("search-bar-active");
                    $("#" + maindom).find(".grid-view-bnt").removeClass("dg-bnt-active");
                }else {
                    $search_box.searchbox({
                        searcher: function (value) {
                            ...
                            if (search_field.length > 0) {
                                ...
                                if(old_opts.isKanban){
                                    ...
                                    filter_data['filter']["filter_input"] = search_field;
                                ...
                                //保存过滤条件缓存
                                Strack.save_filter_cache(bardom, 'filter_input', search_field);
                                Strack.show_nosaved_filter(bardom, 'filter_input', StrackLang["Search_Filter"]);
                            } else {
                                layer.msg(StrackLang["Choice_Search_Fields"], {icon: 2, time: 1200, anim: 6});
                            }
                        },
                        height: 28,
                        width: 280,
                        buttonRightVal: 42,
                        buttonFilter: true,
                        filterBar: opts.searchConfig.filterBar,
                        prompt: StrackLang["Search_More"]
                    });
                }

                //判断过滤面板是否隐藏
                if(opts.renderNewPage){
                    $("#" + bardom).addClass("filter-min");
                }

                if (opts.searchConfig.bar_show !== "yes" || opts.authorityRules.filter.show !== "yes") {
                    Strack.apply_toggle_filter(opts.searchConfig.filterBar.bar_dom, opts.searchConfig.filterBar.main_dom, 'hide');
                }else {
                    Strack.apply_toggle_filter(opts.searchConfig.filterBar.bar_dom, opts.searchConfig.filterBar.main_dom, 'show');
                }
            }

            $.ajax({
                type: 'POST',
                url: StrackPHP["getGridPanelData"],
                data: {
                    page: page,
                    schema_page: opts.filterConfig.schema_page,
                ...
                dataType: 'json',
                beforeSend: function () {
                    $fmain.append(Strack.loading_dom(opts.filterConfig.loading_type, "", "filter"));
                },
                success: function (data) {

                    build_filter(dg, opts, bardom, maindom, data);

                    //生成右键菜单 DOM
                    if (opts.showContextMenu) {
                        opts.contextMenuData.data = Strack.generate_grid_right_menu(opts);
                        Strack.right_menu_dom(opts.contextMenuData);
                    }

                    $("#st-load_filter").remove();
                }
            });
        }
    }
    ...
    //生成过滤条件面板
    function build_filter(dg, opts, bardom, maindom, data) {
        var grid_id = $(dg).attr('id');
        var dom = '';
        var $fid = $("#" + opts.filterConfig.id);

        var $grid_tool = $('.grid-tool-item'),
            $grid_kanban = $('.kanban-mode-list');
        ...
        if (opts.authorityRules.filter.show === "yes") {
            if (!$.isEmptyObject(data["filter_bar"])) {
                ['stick', 'my', 'public'].forEach(function (key) {
                    if (data["filter_bar"][key].length > 0) {
                        dom += filter_term_header(key);
                        data["filter_bar"][key].forEach(function (val) {
                            if (parseInt(val.filter_id) === parseInt(opts.panelConfig.active_filter_id)) {
                                val.select = true;
                            }
                            dom += filter_term_item(val);
                        });
                    }
                });
            }
            ...
            //过滤条件tag列表
            $fid.empty()
                .append(term_wrap_dom(dom, opts))
                .append(filter_main_wrap(opts.authorityRules.filter.edit, opts))
                .find('.filter-task-panel').panel(
                {
                    border: false,
                    width: 279
                }
            ...
            $('#' + opts.toolbarConfig.id).find(".custom-menu-item").remove();

            //过滤面板下拉列表
            var fbar_list_dom = filter_field_list(data["filter_list"], 'bar');
            $fid.find(".filter-task-list").empty().append('<div class="ui vertical menu">' + fbar_list_dom + '</div>');

            //过滤输入框可过滤字段
            var fsearch_list_dom = filter_field_list(data["search_list"], 'search');
            var $search_list = $("#search_list_" + bardom);
            if($search_list.length > 0){
                $search_list.empty().append('<div class="ui vertical menu">' + fsearch_list_dom + '</div>');
            }else {
                $("body").append('<div id="search_list_' + bardom + '" class="filter-task-list" data-maindom="' + maindom + '"><div class="ui vertical menu">' + fsearch_list_dom + '</div></div>');
            }
            Strack.init_dropdown();
        }

        //初始化工具栏可以排序项
        if (opts.toolbarConfig.sortAllow && opts.authorityRules.sort === "yes") {
            var $grid_sort = $('#' + opts.toolbarConfig.id).find(".grid_sort");
            $grid_sort.append(Strack.toolbar_down_init('sort', data["sort_list"], opts, 'grid'));
            //初始化排序高亮按钮
            Strack.init_show_sort_down_icon($grid_sort, opts["sortConfig"]["sort_data"], opts["sortConfig"]["sort_type"]);
        }
        ...
        if (opts.toolbarConfig.groupAllow && opts.authorityRules.group === "yes") {
            ...
            if(opts.isKanban){
                ...
                $('#' + opts.toolbarConfig.id).find(".grid_group").append(group_dom);
            }
        }

        //初始化工具栏可以显示项
        if (opts.toolbarConfig.fieldAllow) {
            $('#' + opts.toolbarConfig.id).find(".grid_fields").append(Strack.toolbar_down_init('show', data["show_list"], opts, 'grid'));
        }

        //初始化工具栏视图项
        if (opts.toolbarConfig.viewAllow) {
            $('#' + opts.toolbarConfig.id).find(".grid_view").append(Strack.toolbar_view_init('view', data["view_list"], 'grid'));
        }

        //初始化工具栏工序项
        if (opts.toolbarConfig.stepAllow) {
            $('#' + opts.toolbarConfig.id).find(".step_view").append(Strack.toolbar_step_init('step', data["step_list"], opts, 'grid'));
        }

        // 初始化常用action列表
        if(opts.toolbarConfig.actionAllow){
            $('#' + opts.toolbarConfig.id).find(".common_action").empty().append(Strack.toolbar_common_action(grid_id, opts, data["common_action_list"]));
        }
    }

    //过滤面板包裹
    function filter_main_wrap(auth_edit, opts) {
        var dom = '';
        dom += ' <div class="grid-filter-right filter-adv-list">' +
            filter_main_header(auth_edit, opts) +
            '<div class="filter-task-list"></div>' +
            filter_main_bnt() +
            filter_main_panel() +
            '</div>';
        return dom;
    ...
    //重置过滤条件tag列表
    function reload_filter_tags(dg, opts, param) {
        var $fmain = $('#' + opts.filterConfig.id);
        var page = $fmain.attr("data-page"),
            module_code = $fmain.attr("data-modulecode"),
            module_type = $fmain.attr("data-moduletype"),
            maindom = $fmain.attr("data-maindom"),
            bardom = $fmain.attr("data-bardom"),
            project_id = $fmain.attr("data-projectid");

        $.ajax({
            type: 'POST',
            url: StrackPHP["getGridFilterBarData"],
            data: {
                page: page,
            ...
            dataType: 'json',
            beforeSend: function () {
                $fmain.append(Strack.loading_dom('white', "", "filter"));
            },
            success: function (data) {
                ...
                $fmain.find(".exist-filter-item").empty().append(dom);

                Strack.do_reset_filter(maindom, bardom, false);

                //选择当前保存的bar item
                if (param) {
                    var c_item = $fmain.find(".filter-bar-index-" + param.id);
                    Strack.toggle_ac_filter(c_item[0]);
                }
    ...
    //工具栏下拉菜单
    function toolbar_down_self(ldom) {
        var dom = '';
        dom += '<div class="scrolling menu">' +
            ldom +
            '</div>';
        return dom;
    }
    ...
    //过滤面板头部
    function filter_main_header(auth_edit, opts) {
        var dom = '';
        dom += '<div class="filter-header p-wrap-filter">' +
            '<div class="aign-left">' +
            '<a href="javascript:;" class="st-dropdown" onclick="Strack.show_filter_filter(this);">' + StrackLang['Add_Filter'] + '<i class="dropdown icon"></i></a>' +
            '</div>' +
            '<div class="aign-right">' +
            '<div class="ui dropdown st-dropdown">' + StrackLang['Advanced'] + '<i class="icon-right icon-uniE60D"></i>' +
            '<div class="menu" style="left:-20px">';
        if(auth_edit === "yes"){
            dom +='<a href="javascript:;" class="item" onclick="Strack.save_filter_condition(this);">' + StrackLang["Save_Filter"] + '</a>';
        }

        dom +='<a href="javascript:;" class="item" onclick="Strack.reset_filter_default(this);">' + StrackLang["Reset_Default"] + '</a>';

        if(opts.allowAdvanceFilter){
            dom +='<a href="javascript:;" class="item" onclick="Strack.open_advance_filter(this);">' + StrackLang["Advanced_Filter"] + '</a>';
        }
    ...
    //过滤面板
    function filter_main_panel() {
        var dom = '';
        dom += '<div class="filter-task-main p-wrap">' +
            '<div class="filter-task-panel">' +
            '<div class="no-filter-task">' + StrackLang["No_Filter_Item"] + '</div>' +
            '</div>' +
            '</div>';
        return dom;
    }
    ...
    //过滤字段列表
    function filter_field_list(field_list, from) {
        var dom = '', mdom;
        for (var key in field_list) {
            for (var item in field_list[key]) {
                if (!$.isEmptyObject(field_list[key][item]["fields"])) {
                    mdom = '';
                    field_list[key][item]["fields"].forEach(function (val) {
                        val['belong'] = field_list[key][item]["title"];
                        val["module_code"] = key;
                        mdom += field_item_menu(val, from);
                    });
                    dom += field_list_item(field_list[key][item]["title"], mdom);
                }
            }
        }
        return dom;
    ...
    //过滤字段列表
    function field_list_item(title, mdom) {
        var dom = '';
        dom += '<div class="ui dropdown item">' +
    ...
    //过滤字段菜单列表
    function field_item_menu(param, from) {
        var dom = '';
        var variable_id = param.field_type === "built_in" ? 0 : param.variable_id;
        var data_source = param.data_source ? param.data_source : '';

        // 判断水平关联过滤（暂时使用）
        if(variable_id > 0 && $.inArray(param.type, ["horizontal_relationship", "belong_to"]) >=0 ){
            param.module_code = param['is_master'] === "yes" ? param.fields : param.module_code+"_"+param.fields;
            param.table = param.module_type === "entity" ? param.module_type: param.module_code;
            param.fields= "id";
        }

        dom += '<a href="javascript:;" class="item field-item" onclick="Strack.toggle_filter_item(this);" from="' + from + '" field="' + param.fields + '" field_type="' + param.field_type + '" module_id="' + param.module_id + '" module_code="' + param.module_code + '" variable_id="' + variable_id + '" project_id="' + param.project_id + '"  table="' + param.table + '" editor="' + param.editor + '" lang="' + param.lang + '" belong="' + param.belong + '"  value_show="' + param.value_show + '" flg_module="' + param.flg_module + '" frozen_module="' + param.frozen_module + '" data_source="'+data_source+'">' +
    ...
    //过滤面板控件
    function filter_main_bnt() {
        var dom = '';
        dom += '<div class="filter-task-button">' +
            '<a href="javascript:;" class="st-dialog-button st-button-base button-dgsub" onclick="Strack.filter_manual(this);" data-auto="manual">' + StrackLang["Search"] + '</a>' +
            '<div class="aign-left project-checkbox">' +
            '<input class="icon-left filter_auto_in" type="checkbox">' +
            '<span class="filter_auto_check">' + StrackLang["Auto_Filter"] + '</span>' +
            '</div>' +
            '</div>';
        return dom;
    }
    ...
    //未保存过滤条件
    function unsave_filter_item() {
        var dom = '';
        dom += filter_term_header("unsaved");
        dom += unsave_term_item();
        return dom;
    }

    function unsave_term_item() {
        var dom = '';
        dom += '<div class="filter-tag-item filter-tag-ac">' +
            '<a href="javascript:;" class="item-name aign-left" onclick="Strack.toggle_ac_filter(this)" filter_type="unsave" filter_id="0">' +
            '<div class="ui grey label filter-tag-label"></div>' +
            '<div class="filter-tag-name text-ellipsis"></div>' +
            '</a>' +
            '<a class="item-bnt aign-left fbar-save-bnt" onclick="Strack.save_active_filter(this)"><i class="icon-uniF0C7"></i></a>' +
            '<a class="item-bnt aign-left" onclick="Strack.delete_unsave_filter(this)"><i class="icon-uniE6DB"></i></a>' +
            '</div>';
        return dom;
    }

    //过滤条件包裹 DOM
    function term_wrap_dom(fdom, opts) {
        var bar_show = opts.searchConfig.bar_show;
        unsave_filter_item();
        var dom = '', stick_css = '', stick_lang = '';
        if (bar_show === 'yes') {
            stick_css = 'stick-on';
            stick_lang = StrackLang["Cancel_Keep"];
        } else {
            stick_lang = StrackLang["Keep_Display"];
        }
        if (!fdom) {
            fdom = '<div class="datagrid-empty-no">' + StrackLang["No_Filter_List"] + '</div>';
        }
        dom += '<div class="grid-filter-left filter-label-list">' +
            '<div class="filter-header filter-label">' +
            '<div class="aign-left filter-label-pin">' +
            '<a href="javascript:;" class="st-dropdown filter_list ' + stick_css + '" onclick="Strack.stick_filter_bar(this);"><i class="pin icon icon-left"></i><span>' + stick_lang + '</span></a>' +
            '</div>' +
            '<div class="aign-right filter-label-bnt">' +
            '<a href="javascript:;" class="st-dropdown filter_list" onclick="Strack.toggle_filter_main(this);"><i class="icon-uniE94E"></i></a>' +
            '</div>' +
            '</div>' +
            '<div class="filter-tag-list">' +
            '<a href="javascript:;" class="reset-filter-item" onclick="Strack.reset_filter_default(this);">' + StrackLang["Reset_Default"] + '</a>' +
            '<div class="unsaved-filter-item">' + unsave_filter_item() + '</div>' +
            '<div class="exist-filter-item">' + fdom + '</div>' +
            '</div>' +
            '</div>';
        return dom;
    }

    function filter_term_header(type) {
        var dom = '', icon = '', title = '';
        switch (type) {
            case "unsaved":
                //未保存的
                icon = 'icon-uniE6A7';
                title = StrackLang["Unsaved"];
                break;
            case "stick":
                icon = 'icon-uniE8BA';
                title = StrackLang["Stick"];
                break;
            case "my":
                icon = 'icon-uniF21D';
                title = StrackLang["My"];
            ...
            case "public":
                icon = 'icon-uniF1E0';
                title = StrackLang["Public"];
                break;
        }
        dom += '<div class="filter-tag-group">' +
            '<i class="' + icon + ' icon-left"></i>' +
            '<span class="filter-group-name text-ellipsis">' +
            title +
            '</span>' +
            '</div>';
        return dom;
    ...
    function filter_term_item(data) {
        var dom = '';
        var ac_css = data.select ? 'filter-tag-ac' : '';
        dom += '<div class="filter-tag-item ' + ac_css + '" filter_id="' + data.id + '">' +
            '<a href="javascript:;" class="item-name aign-left filter-bar-index-' + data.id + '" onclick="Strack.toggle_ac_filter(this)" filter_type="exist" filter_id="' + data.id + '">' +
            '<div class="ui ' + data.color + ' label filter-tag-label"></div>' +
            '<div class="filter-tag-name text-ellipsis">' + data.name + '</div>' +
            '</a>';
        dom += '<a class="item-bnt aign-left" onclick="Strack.filter_item_stick(this)" filter_id="' + data.id + '" stick="' + data.stick + '"><i class="' + data.icon + '"></i></a>';
        if (data.allow_del) {
            dom += '<a class="item-bnt aign-left" onclick="Strack.filter_item_delete(this)" filter_id="' + data.id + '"><i class="icon-uniE6DB"></i></a>';
        }
        dom += '</div>';
        return dom;
    }

    function replace_html_tag(str) {
        str = str.replace(/<\/?[^>]*>/g, '');
        return str;
    }

    //创建grid剪切板
    function grid_clipboard(dom) {
        var clip_val = "", $board = $("#grid_clipboard");
        if (dom) {
            clip_val = replace_html_tag($(dom).html());
        }
        if ($board.length > 0) {
            $board.val(clip_val);
        } else {
            $("body").append('<input id="grid_clipboard" type="text" style="position: absolute;top:-9999px" value="' + clip_val + '"/>');
        }
    }

    //重置表格列设置
    function reset_grid_column() {

    }

    //判断字段所处位置
    function checkFieldRegion(frozen_fields, cols_fields, target) {
        if ($.inArray(target, frozen_fields) >= 0) {
            return 'frozen';
        }
        if ($.inArray(target, cols_fields) >= 0) {
            return 'nofrozen';
        }
    }

    //获取当前字段值
    function build_index(key_list, now) {
        if ($.inArray(now, key_list) < 0) {
            return now;
        } else {
            now++;
            return build_index(key_list, now);
        }
    }
            ...
            return {
                init: function (_73c, _73d) {
                    ...
                    if (_73e[name] && name !== "text") {
                        if(name !== 'tagbox'){
                            var cell_h = $(_73c).closest(".datagrid-row").height();
                            if (_73d && _73d.height > 0) {
                                _73d.height = cell_h;
                            } else {
                                _73d = {
                                    height: cell_h
                ...
                setValue: function (_741, _742) {
                    if (isA(_741, name)) {
                        ...
                        if (opts.multiple) {
                            if (_742) {
                                if(_742.hasOwnProperty('rows')){
                                    var val_list = [];
                                    _742["rows"].forEach(function (val) {
                                        val_list.push(val["id"]);
                                    });
                                    $(_741)[name]("setValues", val_list);
                                }else {
                            ...
                            if(_742 && _742.hasOwnProperty("rows")){
                                $(_741)[name]("setValue", _742["rows"][0]["id"]);
                            }else {
                ...
                resize: function (_743, _744) {
                    if (isA(_743, name)) {
                        ...
                        $(_743)._outerWidth(_744)
                            ._outerHeight($(_743).closest(".datagrid-row").height());
                    }

                    if(name === 'tagbox'){
                        // tagbox 控件尺寸修正
                        var mh = $(_743).closest(".datagrid-row").height();
                        $(_743).next('.tagbox').css({
                            "min-height": mh - 2
                        }).find("a.combo-arrow").css({
                            "min-height": mh - 2
                        });
                    }
                }
    ...
    //生成datagrid editor 控件配置
    var _745 = $.extend({}, _737(["text", "textbox", "tagbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            ...
            resize: function (_74c, _74d) {
                var mh = $(_74c).closest(".datagrid-row").height();
                $(_74c)._outerWidth(_74d).css({
                    "min-width": _74d - 10,
                    "max-width": _74d - 10,
                    "min-height": mh - 4
                });
        ...
        checkbox: {
            ...
            resize: function (_75c, _75d) {
                var cw = ($(_75c).closest(".datagrid-row").height() - 13) / 2;
                $(_75c).css("margin-top", cw);
            }
        },
        validatebox: {
            ...
            resize: function (_75c, _75d) {
                $(_75c)._outerWidth(_75d)
                    ._outerHeight($(_75c).closest(".datagrid-row").height());
            }
        }
    });
    ...
    $.fn.datagrid.methods = {
        ...
        setOptions: function (jq, _opt) {
            return jq.each(function () {
                var opts = $(this).datagrid("options");
                $.each(_opt, function (i) {
                    opts[i] = _opt[i];
                });
                if(_opt.columns){
                    //重新渲染表头
                    _614(jq[0]);
                    $(jq[0]).datagrid('columnMoving');
                    _629(this);
                }
            });
        },
        //设置datagrid查询参数（允许按key修改）
        setFilterParams: function (jq, _opt) {
            return jq.each(function () {
                var opts = $(this).datagrid("options");
                var filter = JSON.parse(opts.queryParams.filter_data);
                $.each(_opt, function (i) {
                    filter['filter'][i] = _opt[i];
                });
                opts.queryParams.filter_data = JSON.stringify(filter);
            });
        },
        //添加临时查询字段, 把新增字段添加到最后面
        addQueryFields: function (jq, _opt) {
            return jq.each(function () {
                var opts = $(this).datagrid("options");
                var col = opts.columns;
                var d_index = col.length - 1;
                var c_col = col[d_index];

                //获取最后字段索引
                var l_index = c_col[c_col.length - 1]["findex"] + 1;

                //新增字段到最后列
                var f_w = _opt["width"] > 120 ? _opt["width"] :120;
                var t_field = {
                    field: _opt["value_show"],
                    title: _opt["lang"],
                    align: 'center',
                    width: f_w,
                    frozen: "frozen",
                ...
                var formatter = Strack.G.gridFieldCache[opts.toolbarConfig.page][_opt.value_show]["outreach_formatter"];
                if (formatter) {
                    t_field["formatter"] = function (value, row, index) {
                ...
                if(col.length > 1){
                    var f_col = col[0];
                    var last_f_col = f_col[f_col.length - 1];
                    if(last_f_col["step"] === "yes"){
                        f_col.push({
                            bgc :"",
                            but : "",
                            class : "",
                        ...
                        last_f_col["colspan"] = parseInt(last_f_col["colspan"]) + 1;
                        f_col[f_col.length - 1] = last_f_col;
                    }
                    col[0] = f_col;
                }
                ...
                //新增字段到查询条件
                var d_filter = JSON.parse(opts.queryParams.filter_data);
                d_filter.filter.temp_fields.add[_opt["value_show"]] = {
                    field: _opt["field"],
                    value_show: _opt["value_show"],
                    module_code: _opt["module_code"],
                    module_type: _opt["module_type"]
                };
                delete d_filter.filter.temp_fields.cut[_opt["value_show"]];
                opts.queryParams.filter_data = JSON.stringify(d_filter);
        ...
        //删除临时查询字段
        cutQueryFields: function (jq, _opt) {
            return jq.each(function () {
                var opts = $(this).datagrid("options");
                var d_index = opts.columns.length - 1;
                //首先得知道当前取消字段
                var cols = opts.columns[d_index],
                    frozen_col = opts.frozenColumns[d_index];
                var region, frozen_key = [];
                //非固定区域字段
                cols.forEach(function (val, index) {
                    if (cols[index].field === _opt["value_show"]) {
                        cols.splice(index, 1);
                        region = "nofrozen";
                    }
                });
                //固定区域字段
                frozen_col.forEach(function (val, index) {
                    if (frozen_col[index].field ===_opt["value_show"]) {
                        frozen_col.splice(index, 1);
                        region = "frozen";
                    }
                    frozen_key.push(val["findex"]);
                });
                var k_index = 0, cnewcc = [];
                cols.forEach(function (bnt, index) {
                    k_index = build_index(frozen_key, k_index);
                    bnt.findex = k_index;
                    k_index++;
                    cnewcc.push(bnt);
                });
                opts.columns[d_index] = cnewcc;
                opts.frozenColumns[d_index] = frozen_col;

                // 两层表头调整第一层 colspan
                if(d_index === 1){
                    //双表头
                    var zore_index = {};
                    opts.columns[0].forEach(function (top) {
                        if (top.but) {
                            zore_index[top.but] = top;
                        }
                    });
                    var zore_col = [], crow = [];
                    cols.forEach(function (bnt, index) {
                        if (bnt.belong) {
                            if ($.inArray(bnt.belong, crow) < 0) {
                                zore_col.push(zore_index[bnt.belong]);
                                crow.push(bnt.belong);
                            }
                        } else {
                            if (crow[crow.length - 1] == "col") {
                                zore_col[crow.length - 1].colspan = zore_col[crow.length - 1].colspan + 1;
                            } else {
                                zore_col.push({
                                    bgc: "",
                                    but: "",
                    ...
                    opts.columns[0] = zore_col;
                }

                //新增字段到查询条件
                var d_filter = JSON.parse(opts.queryParams.filter_data);

                d_filter.filter.temp_fields.cut[_opt["value_show"]] = {
                    field: _opt["field"],
                    value_show: _opt["value_show"],
                    module_code: _opt["module_code"],
                    module_type: _opt["module_type"]
                ...
                delete d_filter.filter.temp_fields.add[_opt["value_show"]];
                opts.queryParams.filter_data = JSON.stringify(d_filter);
        ...
        //应用分组
        applyGroup: function (jq, _opt) {

        },
        //应用分组
        cancelGroup: function (jq, _opt) {

        },
        //动态改变datagrid字段
        setColumns: function (jq, _opt) {
            return jq.each(function () {
                var opts = $(this).datagrid("options"),
                    dc = $.data(jq[0], "datagrid").dc,
                    nopts = [], isindex = true;
                switch (_opt["ishide"]) {
                    case "de":
                        opts["columns"][0].forEach(function (col) {
                            if (col["field"] != _opt["field"]) {
                                nopts.push(col);
                            }
                        });
                        break;
                    case "add":
                        opts["columns"][0].forEach(function (col, index) {
                            if (_opt["index"] < col["findex"] && isindex) {
                                nopts.push(_opt["setting"]);
                                isindex = false;
                            }
                            nopts.push(col);
                        });
                ...
                opts["columns"][0] = nopts;
                _614(jq[0]);
            });
        },
        // 重置工序字段扩列设置
        ResetStepColumnColspan: function(jq, _opt) {
            return jq.each(function () {
                var opts = $(this).datagrid("options");
                ...
                if (opts.columns.length > 1) {
                    // 两层表头
                    opts.columns[0].forEach(function (val, index) {
                        if(val["step"] === "yes" && val["but"] === _opt["step"]){
                            opts.columns[0][index]["colspan"] = _opt["colspan"];
                            if(_opt["colspan"] === 1){
                                opts.columns[0][index]["fhcol"] = true;
                            }else {
                                opts.columns[0][index]["fhcol"] = false;
                            }
                        }
                    });
                    // 处理所属字段
                    opts.columns[1].forEach(function (val, index) {

                        if(val["belong"] === _opt["step"]){
                            if($.inArray(val["field"], _opt["field_list"]) !== -1){
                                if(_opt["colspan"] === 1){
                                    _787.find('td[field="' + val["field"] + '"]').hide();
                                    opts.columns[1][index]["hidden"] = true;
                                }else {
                                    _787.find('td[field="' + val["field"] + '"]').show();
                                    opts.columns[1][index]["hidden"] = false;
                                }
                            }else {
                                // 处理第一个字段显示样式
                                if(_opt["colspan"] === 1){
                                    opts.columns[1][index]["cbd"] = "colboth";
                                }else {
                                    opts.columns[1][index]["cbd"]= "colleft";
                                }
                            }
                        }
                    });
        ...
        //冻结datagrid字段
        FrozenColumn: function (jq, _opt) {
            return jq.each(function () {
                var opts = $(this).datagrid("options");
                var cols, fcols, c_index = -1, c_fd, in_index = -1;
                if (opts.columns.length > 1) {
                    //两层表头
                    cols = opts.columns[1];
                    fcols = opts.frozenColumns[1];
                    switch (_opt["isfrozen"]) {
                        case "frozen":
                            cols.forEach(function (val, index) {
                                if (val.field == _opt.field) {
                                    c_index = index;
                                    val.frozen = "nofrozen";
                                    c_fd = val;
                                }
                            });
                            cols.splice(c_index, 1);
                            fcols.push(c_fd);
                            break;
                        case "nofrozen":
                            fcols.forEach(function (val, index) {
                                if (val.field == _opt.field) {
                                    c_index = index;
                                    val.frozen = "frozen";
                                    c_fd = val;
                            ...
                            fcols.splice(c_index, 1);
                            cols.every(function (val, index) {
                                if (val.findex > c_fd.findex) {
                                    in_index = index;
                                    return false;
                                }
                                return true;
                            ...
                            if (in_index == -1) {
                                ...
                                cols.splice(in_index, 0, c_fd);
                            }
                            break;
                    }
                    opts["frozenColumns"][1] = fcols;
                    opts["columns"][1] = cols;
                    //处理1级表头
                    opts["frozenColumns"][0] = [{colspan: fcols.length}];
                    var zore_index = {};
                    opts["columns"][0].forEach(function (top) {
                        if (top.but) {
                            zore_index[top.but] = top;
        ...
        // 添加新的step cols
        appendStepColumn: function(jq, config){
            return jq.each(function () {
                var opts = $(this).datagrid("options");
                opts.columns[0].push(config["first"]);
                config["second"].forEach(function (val) {
                    opts.columns[1].push(val);
                });
                _614(jq[0]);
                $(jq[0]).datagrid('columnMoving');
                _629(this);
        ...
        //高亮视图改变
        highlightViewSave: function (jq) {
            var $view_bnt = $(jq[0]).closest(".datagrid-wrap").find(".grid-view-bnt");
            $view_bnt.addClass("dg-bnt-active");
        },
        //删除高亮视图改变
        delHighlightViewSave: function (jq) {
            var $view_bnt = $(jq[0]).closest(".datagrid-wrap").find(".grid-view-bnt");
            $view_bnt.removeClass("dg-bnt-active");
        },
        ...
        reload: function (jq, _765) {
            return jq.each(function () {
                ...
                if(opts.isKanban){
                    ...
                    // 刷新数据表格
                    opts.gridDirtyData.list = [];
                    opts.gridDirtyData.value = {};
        ...
        getRow: function (jq, index) {
            return $.data(jq[0], "datagrid").data.rows[parseInt(index)];
        },
        getRows: function (jq) {
        ...
        //显示当前表格选中的行数
        showSelectedNumber: function (jq) {
            var $page = $(jq[0])
                .closest(".entity-datalist")
                .find(".datagrid-pager .pagination-selected");
            if ($page.length) {
                var num = _6a6(jq[0]).length;
                if (num > 0) {
                    $page.html('已选中行数: ' + num);
                } else {
                    $page.html('');
        ...
        //重新加载过滤tag
        reloadFilterTags: function (jq, param) {
            var opts = $(jq).datagrid("options");
            reload_filter_tags(jq, opts, param);
        },
    ...
    var _790 = {
        render: function (_791, _792, _793) {
            var rows = $(_791).datagrid("getRows"),
                alldata = $(_791).datagrid("getData");
            $(_792).html(this.renderTable(_791, 0, rows, _793, alldata["total"]));
        },
        ...
        //渲染表格
        renderTable: function (_799, _79a, rows, _79b, total) {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                if (!$.isEmptyObject(row)) {
                    ...
                    _79e.push(this.renderRow.call(this, _799, _79d, _79b, _79a, row, total));
                    _79e.push("</tr>");
                }
                _79a++;
            }
        ...
        renderRow: function (_7a3, _7a4, _7a5, _7a6, _7a7, total) {
            var opts = $.data(_7a3, "datagrid").options;
            var cc = [];
            if (_7a5 && opts.rownumbers) {
                //判断是否全部加载
                opts.pageSize = opts.pageSize == "All" ? total : opts.pageSize;
                var _7a8 = _7a6 + 1;
                if (opts.pagination) {
            ...
            for (var i = 0; i < _7a4.length; i++) {
                ...
                if (col) {
                    ...
                    if ($.inArray(col.field + '_' + _7a6, opts.gridDirtyData["list"]) >= 0) {
                        _class.push("grid-cell-dirty");
                    }

                    _class.push("is-grid-td");
                    ...
                    if (col.bdc) {
                        switch (col.cbd ){
                            case "colboth" :
                                if(Strack.G.gridFirstColMap[col["belong"]]){
                                    _bdc += 'border-color:#DDD #DDD #DDD #' + col.bdc + ';border-style: dotted dotted dotted solid;border-width: 0px 1px 1px 3px';
                                }else {
                                    _bdc = 'border-color:#DDD #' + col.bdc + ';';
                                }
                                break;
                            default:
                                _bdc = 'border-color:#DDD #' + col.bdc + ';';
                    ...
                    var td_cls = col.hidden ? 'display:none;' + _7ac + _bdc : _7ac ? _7ac + _bdc : _bdc ? _bdc  : '';

                    var td_id = _7a9+'_'+_7a7["id"];

                    cc.push('<td id="'+td_id+'" field="' + _7a9 + '" style="' + td_cls + '" ' + cls + ' data-grid="'+opts.id+'">');
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.formatter) {
                            ...
                            var isTimespinner = col.editor && col.editor.type && col.editor.type  === 'timespinner';
                            if (!isTimespinner) {
                                isTimespinner = col.custom_type && col.custom_type === 'timespinner';
                            }
                            if (isTimespinner && _7aa) {
                                _7aa = Strack.format_timespinner_val(_7aa);
                                // var separator;
                                // if (typeof _7aa === 'number') {
                                //     _7aa  = _7aa.toString();
                                // }
                                // var _7aaIsString = typeof _7aa === 'string';
                                // if (_7aaIsString && _7aa.indexOf(":")  !== -1){
                                //     separator = ":";
                                // }
                                // if (_7aaIsString && _7aa.indexOf(".")  !== -1){
                                //     separator = ".";
                                //     _7aa = Number(_7aa).toFixed(2).toString();
                                // }
                                // if (separator) {
                                //     var _7aaSplit = _7aa.split(separator);
                                //     _7aa = _7aaSplit[0] + "小时" + _7aaSplit[1] + "分钟";
                                // }
                            }
        ...
        onAfterRender: function (_7d3) {
            ...
            //删除 entity-datalist class
            var $grid_main = $(_7d3).closest(".entity-datalist");
            $grid_main.removeClass("skeleton-size-full");

            var $page = $grid_main.find(".datagrid-pager .pagination-selected");
            if ($page.length) {
                $page.html("");
            }
            ...
            //渲染完成 绑定自适应事件
            if (opts.adaptive) {
                var exth = opts.adaptive.exth;//表头额外高度
                if (!exth) {
                    exth = 0
                }
                var domresize = opts.adaptive.domresize ? 1 : 0;
                Strack.auto_resize_datagrid(_7d3, opts.adaptive.dom, opts.adaptive.min_width, exth, domresize);
            }

            //当datagrid没有值得时候
            var dnum = 0, dtotal = 0;
            switch (opts.dataGridType) {
                case 'treegrid':
                    dnum = $(_7d3).treegrid("getData");
                    dtotal = dnum.length;
                    break;
                default:
                    dnum = $(_7d3).datagrid("getData");
                    dtotal = parseInt(dnum["total"]);
                    break;
            }

            if (dtotal === 0 && $.inArray(opts.dataGridType, ['datagrid', 'treegrid']) >=0 && !opts.isKanban) {
                var dnonotice = opts.DataNull ? opts.DataNull : StrackLang["Datagird_No_Data"];
                $(_7d3).prev(".datagrid-view2").find('.datagrid-body')
                    .prepend('<div class="datagrid-empty-no">' + dnonotice + '</div>');
            }

            //把显示个数记录全局变量
            Strack.G.GridPage["pageSize"] = opts.pageSize;
            Strack.G.GridPage["pageNumber"] = opts.pageNumber;
        },
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumbers: false,
        rowheight: 31,//默认行高
        differhigh: false,//行高自动赋值
        adaptive: null,//开启自适应
        autocolumns: false,//动态生成列
        gridname: null,//data name
        DragSelect: false,//是否开启拖拽选择
        isKanban: false,
        groupParam: {},
        moduleId: 0,
        projectId: 0,
        showContextMenu: true,//是否允许显示右键菜单
        contextMenuData: {//右键菜单数据
            id: 'st_menu_default',
            copy_id: 'def_copy_cell',
            data: [
                {
                    id: "def_copy_cell",
                    lang: StrackLang["Copy_Grip_Cell"],
                    iconCls: "icon-uniE943",
                    type: "function",
                    click: "Strack.copy_to_clipboard(this)",
                    attr_data: {"clipboard-action": "copy", "clipboard-target": "#grid_clipboard"}
                }
            ]
        },
        HeaderField: false,//顶部字段选项
        HeaderFieldData: null,//顶部字段数据
        HeaderHeight: null,//自定义表头高度
        DataNull: null,
        dataGridType: "datagrid",
        headerAddCheckbox: false,
        cellUpdateMode: 'auto',//单元格编辑后保存模式
        gridDirtyData: {//当前数据表格编辑产生脏数据
            list: [],
            value: {}
        },
        panelConfig: {},
        ...
        authorityRules: { //数据表格权限
            filter: {}
        },
        allowAdvanceFilter: true,
        columnsFieldConfig: {},//当前数据字段配置
        groupActive: false,
        singleSelect: false,
        ctrlSelect: false,
        selectOnCheck: true,
        ...
        pageLayout: ["list", "sep", "first", "prev", "sep", "manual", "sep", "next", "last", "sep", "refresh"],
        queryParams: {},
        sortName: null,
        sortOrder: "asc",
        multiSort: false,
        ...
        showFooter: false,
        scrollbarSize: 18,
        dynamicColumns: false, //动态组装列
        rowEvents: {
            mousedown: _dragSelect(),
            mouseover: _635(true),
            mouseout: _635(false),
            click: _63d,
            dblclick: _647,
        ...
        loader: function (Params, _7dc, _7dd) {
            ...
            if (!opts.renderComplet || opts.renderNewPage) {
                //第一次渲染必要组件
                render_grid_entity(this, opts);
                opts.renderComplet = true;
                opts.renderNewPage = false;
            }

            if(opts.isKanban){
                // 看板数据表格
                var state = $dg.data('datagrid');
                var $kanban = state.dc.view_kanban;
                var states = [];
                var filter_param = JSON.parse(Params['filter_data']);

                // 填充分组字段原数据
                opts.groupParam['group_raw_param'] = opts.columnsFieldConfig[opts.groupParam.group_param.value_show];

                function initMemberBoards(data) {
                    var filter_group = {};
                    var collaborators = [];

                    data['collaborators'].forEach(function (val) {
                        val['state'] = val.id;
                        val['name'] = val.name;
                        val['color'] = '#'+ val.color;
                        val['icon'] = val.icon;
                    ...
                    $kanban.boards({
                        key:  'avenue',
                        name: opts.groupParam.grid_param['module_code']+'_name',
                        data:collaborators,
                        filter_param: filter_param,
                        drag_card : data['drag_auth'],
                        message: {
                            loading: '加载中...',
                            allComplete: '以上是全部内容',
                        ...
                        onUpdate: function (issue, oldState) {
                            // 更新数据
                            var item_data = {};
                            if(opts.groupParam.group_raw_param.field_type === 'built_in'){
                                item_data[opts.groupParam.group_raw_param.module] = [
                                    {
                                        field: opts.groupParam.group_raw_param.module+"-"+opts.groupParam.group_raw_param.field_value_map,
                                        field_type: opts.groupParam.group_raw_param.field_type,
                                        value: issue.avenue,
                                        variable_id: 0
                                    }
                                ];
                            }else{
                                item_data[opts.groupParam.group_raw_param.module_code] = [
                                    {
                                        field: opts.groupParam.group_raw_param.module_code+"-"+opts.groupParam.group_raw_param.field_value_map,
                                        field_type: opts.groupParam.group_raw_param.field_type,
                                        value: issue.avenue,
                                        variable_id: opts.groupParam.group_raw_param.variable_id
                                    }
                                ];
                            }


                            Strack.update_kanban_issue({
                                from_item_id: "0",
                                from_module_id: "0",
                                mode: "modify",
                                module_id: opts.groupParam.grid_param.module_id,
                                page: opts.groupParam.grid_param.page,
                                primary_id: issue.id,
                                project_id: opts.groupParam.grid_param.project_id,
                                type: "update_panel"
                            },item_data);
                        ...
                        onLoad: function (board, callback) {
                            ...
                            filter_group[board.state] = this.filter_param;

                            switch (opts.groupParam.group_raw_param.field_type) {
                                case 'custom':
                                    if(opts.groupParam.group_raw_param.custom_type === 'horizontal_relationship'){
                                        filter_group[board.state]['filter']['request'] = Strack.reset_filter_condition_value(
                                            filter_group[board.state]['filter']['request'],
                                            {
                                                field :"id",
                                                field_type :"custom",
                                                variable_id :opts.groupParam.group_raw_param.variable_id,
                                                ...
                                                condition :"IN",
                                                editor : opts.groupParam.group_raw_param.custom_type,
                                                module_code : opts.groupParam.group_raw_param.fields,
                                                table : opts.groupParam.group_raw_param.fields
                                            }
                                        );
                                    }else {
                                        filter_group[board.state]['filter']['request'] = Strack.reset_filter_condition_value(
                                            filter_group[board.state]['filter']['request'],
                                            {
                                                field : opts.groupParam.group_raw_param.fields,
                                                field_type :"custom",
                                                variable_id :opts.groupParam.group_raw_param.variable_id,
                                                value :[
                                                    board.state
                                                ...
                                                condition :"IN",
                                                editor : opts.groupParam.group_raw_param.custom_type,
                                                module_code : opts.groupParam.group_raw_param.module_code,
                                                table :  opts.groupParam.group_raw_param.module
                                            }
                                        );
                                    }
                            ...
                            $.ajax({
                                ...
                                dataType: "json",
                                data: {
                                    filter_data: JSON.stringify(filter_group[board.state]),
                                    page: board.page,
                                    rows: 20
                                }
                            }).done(function (res) {
                                var issues = res['rows'].map(function (issue) {
                                    issue.avenue = issue[opts.groupParam.grid_param['module_code']+'_'+opts.groupParam['group_raw_param']['field_value_map']];
                                    issue.author = {
                                        path : '',
                                        name : issue[opts.groupParam.grid_param['module_code']+'_created_by']
                                    };
                                    issue.state = board.state;
                                    issue.title = issue[opts.groupParam.grid_param['module_code']+'_name'];
                                    issue.created = issue[opts.groupParam.grid_param['module_code']+'_created'];
                                    issue.state_data = {
                                        name: issue[opts.groupParam.grid_param['module_code']+'_status_name'],
                                        icon: issue[opts.groupParam.grid_param['module_code']+'_status_icon'],
                                        color: '#'+issue[opts.groupParam.grid_param['module_code']+'_status_color']
                                    };
                                    return issue
                                });
                ...
                $.ajax({
                    type: opts.method,
                    url: StrackPHP["getGridCollaborators"],
                    contentType: 'application/json',
                    dataType: "json",
                    data: JSON.stringify({
                        param : filter_param,
                        group : opts.groupParam.group_param
                    }),
                    success: function (data) {
                        // 组装甬道
                        initMemberBoards(data);
                    }
                });
        ...
        onClickCell: function (_7ea, _7eb, _7ec, target) {
        },
...
(function ($) {
    ...
    function enterHandler(e) {
        ...
        if(input.closest('.tagbox').length >0){
            // tagbox 类型
            return;
        }
    ...
    function getCurrCell(target) {
        var cell = $(target).datagrid('getPanel').find('td.datagrid-row-on-edit');
        if (cell.length) {
            return {
    ...
    function unselectCell(target, p) {
        ...
        cell.removeClass('datagrid-row-on-edit');
        opts.onUnselectCell.call(target, p.index, p.field);
    }

    function unselectAllCells(target) {
        var panel = $(target).datagrid('getPanel');
        panel.find('td.datagrid-row-on-edit').removeClass('datagrid-row-on-edit');
    }
    ...
    function selectCell(target, p) {
        ...
        var cell = opts.finder.getTr(target, p.index).find('td[field="' + p.field + '"]');
        cell.addClass('datagrid-row-on-edit');
    ...
    function getSelectedCells(target) {
        var cells = [];
        var panel = $(target).datagrid('getPanel');
        panel.find('td.datagrid-row-on-edit').each(function () {
            var td = $(this);
            cells.push({
    ...
    function gotoCell(target, p) {
        ...
        var cell = panel.find('td.datagrid-row-on-edit');
        if (!cell) {
            return;
        }
    ...
    function endCellEdit(target, accepted) {
        ...
        if (cell) {
            ...
            if (input) {
                ...
                var field_config = opts.columnsFieldConfig[cell.field];
                if(field_config['editor'] === 'task_repeat') {
                    dg.datagrid('endEdit', cell.index);
                }
            }
        }
        ...
        if (col.editor) {
            switch (col.editor.type){
                case "horizontal_relationship":
                    ...
                    if(row[param.field] && row[param.field]["total"] > 0){
                        row[param.field]["rows"].forEach(function (val) {
                            link_data.push(val["id"]);
                        });
                    }

                    Strack.open_h_relationship_dialog({
                        project_id : opts.projectId,
                        src_module_id : opts.moduleId,
                        variable_id: col.variable_id,
                        dst_module_id : col.editor.relation_module_id,
                        src_link_id:row.id,
                        link_data : link_data,
                        grid_id : target.id,
                        from : 'widget'
                ...
                case 'relation':
                    ...
                    var field_config = opts.columnsFieldConfig[param.field];

                    Strack.open_has_many_dialog({
                        field: param.field,
                        field_module: field_config["module"],
                        field_table: field_config["table"],
                        project_id : opts.projectId,
                        src_module_id : opts.moduleId,
                        variable_id: col.variable_id,
                        dst_module_id : col.editor.relation_module_id,
                ...
                case "upload":
                    ...
                    var $item_dom = tr.find("td[field="+param.field+"]");
                    var field_type = opts.columnsFieldConfig[param.field]["field_type"];
                    var variable_id = opts.columnsFieldConfig[param.field]["variable_id"];
                    Strack.open_change_item_media({title: StrackLang['Modify_Thumb'], link_id:row.id, module_id: opts.moduleId, mode: "single", from: 'grid', td_dom: $item_dom, index: param.index, field_type: field_type, variable_id: variable_id}, function () {});
                    dg.datagrid('gotoCell', param);
                    break;
                case "task_repeat":
                    // 任务重复设置
                    ...
                    var tr = opts.finder.getTr(target, param.index);
                    var $item_dom = tr.find("td[field="+param.field+"]");
                    var td_offset = $item_dom.offset();
                    var td_height = $item_dom.height();
                    var td_width = $item_dom.width();
                    var $td_cell = $item_dom.find('.datagrid-cell');
                    var field_config = Strack.deep_copy(opts.columnsFieldConfig[param.field]);

                    field_config['value'] = row[field_config.field_map];
                    field_config['primary'] = row['id'];

                    // 激活单元格编辑
                    $td_cell.addClass('datagrid-editable');

                    field_config['row_h'] = td_height;
                    field_config['row_w'] = td_width;
                    field_config['row_offset'] = td_offset;

                    $td_cell.closest('td').addClass('datagrid-row-on-edit');

                    $td_cell.closest('.datagrid-row').addClass('datagrid-row-editing');

                    // 初始化编辑器
                    Strack.dg_ask_repeat_editor_dom($td_cell, row, field_config);
                    break;
                default:
            ...
            if (tr.length && tr.parent().length) {
                ...
                if (td.length) {
                    ...
                    if (opts.singleSelect) {
                        ...
                        if (opts.ctrlSelect) {
                            if (e.ctrlKey) {
                                if (td.hasClass('datagrid-row-on-edit')) {
    ...
    function disableCellSelecting(target) {
        ...
        panel.unbind('.cellediting').find('td.datagrid-row-on-edit').removeClass('datagrid-row-on-edit');
        var dc = state.dc;
     ...
     * 选中表格
     */
    function gridChoiceRow(keyCode, opts) {
        switch (keyCode) {
            case 16:
                Strack.G.shiftOrCtrlKeyPress = 'shift';
                break;
            case 17:
                Strack.G.shiftOrCtrlKeyPress = 'ctrrl';
                break;
        }
    }

    function enableCellEditing(target, jq) {
        var dg = $(target);
        var opts = dg.datagrid('options');
        var panel = dg.datagrid('getPanel');
        ...
        panel.panel('panel').unbind('.cellediting').bind('keydown.cellediting', function (e) {
            gridChoiceRow(e.keyCode, opts);
            e.stopPropagation();
        }).bind('keydown.cellediting', function (e) {
            gridChoiceRow(e.keyCode, opts);
            e.stopPropagation();
        }).bind('keyup.cellediting', function (e) {
            Strack.G.shiftOrCtrlKeyPress = false;
            Strack.G.shiftOrCtrlRowData = {'start': 0, 'end': 0};
            e.stopPropagation();
        }).bind('mouseover.cellediting', function (e) {
            var td = $(e.target).closest('td[field]');
            if (td.length) {
        ...
        opts.onClickCell = function (index, field, value, target) {
            if(!$(target).hasClass('widget-edit')){
                var $parent_td = $(target).closest("td");
                var pw = $parent_td.find(".datagrid-cell").width();

                if (($(target).hasClass("dg-hid-icon") || $(target).closest(".dg-hid-icon").length > 0) && opts.bntToEdit) {
                    $(this).datagrid('editCell', {index: index, field: field});
                    $parent_td.css({width: pw}).prepend('<div class="placeholder" style="width:' + pw + 'px"></div>');
                } else if (opts.clickToEdit) {
                    $(this).datagrid('editCell', {index: index, field: field});
                    $parent_td.css({width: pw}).prepend('<div class="placeholder" style="width:' + pw + 'px"></div>');
                } else {
    ...
    $.extend($.fn.datagrid.methods, {
        columnMoving: function (jq) {
            return jq.each(function () {
                ...
                var view_row = $(this).datagrid('getPanel').find('.datagrid-view2 .datagrid-header-row');

                if (view_row.length > 1) {
                    cells = $(this).datagrid('getPanel').find('div.datagrid-header td.drag-yes');
                } else {
                    cells = $(this).datagrid('getPanel').find('div.datagrid-header td[field]');
                }

                var cell_id = $(this).datagrid('getPanel').find('div.datagrid-header td[field=id]');
                cell_id.droppable({
                    disabled: true
                });
                ...
                cells.draggable({
                    ...
                    proxy: function (source) {
                        var p = $('<div class="tree-node-proxy tree-dnd-no" style="position:absolute;width: 120px"/>').appendTo('body');
                        p.html($(source).text());
                        p.after('<div class="grid-movetop"/><div class="grid-movebottom"/>');
                        p.hide();
                        return p;
                    },
                    onBeforeDrag: function (e) {

                        if($(e.target).hasClass("datagrid-header-check")){
                            return false;
                        }

                        if ($(e.target).hasClass("no-move") && $(e.target).closest(".no-move")) {
                            return false;
                        }
                    ...
                    onDragOver: function (e, source) {
                        if (!($(e.target).closest(".datagrid-view1").length > 0 && $(source).hasClass("clohide"))) {
                            $(source).draggable('proxy').removeClass('tree-dnd-no').addClass('tree-dnd-yes');
                            $(".grid-movetop").css({top: $(this).offset().top - 10, left: $(this).offset().left - 5});
                            $(".grid-movebottom").css({
                                top: $(this).offset().top + 28,
                                left: $(this).offset().left - 5
                            });
                            $('.grid-movetop,.grid-movebottom').show();
                        } else {
                            $(this).droppable("disable");
                        }
                    },
                    onDragLeave: function (e, source) {
                        ...
                        $('.grid-movetop,.grid-movebottom').hide();
                    },
                    onDrop: function (e, source) {
                        $(this).css('border-left', 0);
                        $('.grid-movetop,.grid-movebottom').remove();
                        if (!($(e.target).closest(".datagrid-view1").length > 0 && $(source).hasClass("clohide"))) {
                            var fromField = $(source).attr('field');
                            var formIndex = $(source).attr('row_index');
                            var toField = $(this).attr('field');
                            var toIndex = $(this).attr('row_index');

                            setTimeout(function () {
                                moveField(fromField, toField, formIndex, toIndex);
                                $(target).datagrid();
                                $(target).datagrid('columnMoving');

                                $(target).datagrid("highlightViewSave");
                            }, 0);
                        }
                    }
                });
                ...
                function moveField(from, to, formIndex, toIndex) {
                    var opts = $(target).datagrid('options');
                    var row_index = opts.columns.length - 1,
                        cols = opts.columns[row_index],
                        frozen_cols = opts.frozenColumns[row_index];
                    //当前冻结列参数
                    var frozen_key = [], frozen_fields = [];
                    frozen_cols.forEach(function (fitem) {
                        if (fitem.findex >= 0) {
                            frozen_fields.push(fitem.field);
                            frozen_key.push(fitem.findex);
                        }
                    });

                    //当前非冻结列参数
                    var cols_fields = [];
                    cols.forEach(function (fitem) {
                        cols_fields.push(fitem.field);
                    });

                    //双表头非冻结区域列参数
                    if (row_index > 0) {
                        opts.columns[0].forEach(function (fitem) {
                            if (fitem.but) {
                                cols_fields.push(fitem.but);
                            }
                        });
                    }


                    //整理判断当前字段所在位置，允许从锁定拖动到未锁定，也可以从未锁定到锁定，也允许锁定列相互交换位置
                    var from_region = checkFieldRegion(frozen_fields, cols_fields, from);
                    var to_region = checkFieldRegion(frozen_fields, cols_fields, to);
                    ...
                    function _remove(field) {
                        var c = {};
                        if (from_region == "nofrozen") {
                            //非冻结区域
                            if (row_index > 0) {
                                //双表头
                                if (formIndex == 0) {
                                    //双表头要移除第二列元素重新生成第一列元素
                                    c['bottom'] = [];
                                    var start_index = -1, num = 0;
                                    cols.filter(function (val, index) {
                                        if (val.belong == field) {
                                            if (start_index == -1) {
                                                start_index = index;
                                            }
                                    ...
                                    cols.splice(start_index, num);
                                } else {
                                    for (var i = 0; i < cols.length; i++) {
                                        if (cols[i].field == field) {
                                            if (to_region == "frozen") {
                                                cols[i].frozen = "nofrozen";
                                            }
                                            c['bottom'] = cols[i];
                                            cols.splice(i, 1);
                                        }
                            ...
                            for (var i = 0; i < frozen_cols.length; i++) {
                                if (frozen_cols[i].field == field) {
                                    if (to_region == "nofrozen") {
                                        frozen_cols[i].frozen = "frozen";
                                    }
                                    c['bottom'] = frozen_cols[i];
                                    frozen_cols.splice(i, 1);
                                    return c;
                                }
                            }
                        }
                    ...
                    function _insert(field, c) {
                        ...
                        if (to_region == "nofrozen") {
                                ...
                                if (formIndex == 0) {
                                    if (toIndex == 0) {
                                        ...
                                        cols.forEach(function (val) {
                                            if (val.belong == field && no_add) {
                                                c["bottom"].forEach(function (item) {
                                                    newcc.push(item);
                                                });
                                                no_add = false;
                                            }
                            ...
                            for (var i = 0; i < frozen_cols.length; i++) {
                                ...
                                newcc.push(frozen_cols[i]);
                            }
                        }

                        //重置0级菜单和非冻结区域索引
                        reset_grid_column(newcc);
                    }


                    function reset_grid_column(newcc) {
                        if (to_region == "nofrozen") {
                            //非冻结区域需要重新生成索引
                            nofrozen_zero_menu(newcc);
                            frozen_zero_menu(opts.frozenColumns[row_index]);
                        } else {
                            //冻结区域不需要重新生成索引
                            nofrozen_zero_menu(opts.columns[row_index]);
                            frozen_zero_menu(newcc);
                        }
                    }

                    //生成冻结列零级菜单
                    function frozen_zero_menu(newcc) {
                        var zore_col = [], crow = [];
                        if (row_index > 0) {
                            //双表头
                            newcc.forEach(function (bnt, index) {
                                if (crow[crow.length - 1] == "col") {
                                    zore_col[crow.length - 1].colspan = zore_col[crow.length - 1].colspan + 1;
                                } else {
                                    zore_col.push({
                            ...
                            opts.frozenColumns[0] = zore_col;
                            opts.frozenColumns[1] = newcc;
                        } else {
                            opts.frozenColumns[0] = newcc;
                        }
                    }

                    //生成非冻结列零级菜单
                    function nofrozen_zero_menu(newcc) {
                        var cnewcc = [], k_index = 0, zore_col = [], crow = [];
                        if (row_index > 0) {
                            //双表头
                            var zore_index = {};
                            opts.columns[0].forEach(function (top) {
        ...
        onBeforeRender: function (_83b, rows) {
            ...
            function _83d() {
                if (!$("#datagrid-group-style").length) {
                    $("head").append('<style id="datagrid-group-style">' + ".datagrid-group{height:" + opts.groupHeight + "px;overflow:hidden;font-weight:bold;border-bottom:1px solid #d9d9d9;}" + ".datagrid-group-title,.datagrid-group-expander{display:inline-block;vertical-align:bottom;height:100%;line-height:" + opts.groupHeight + "px;padding:0 4px;}" + ".datagrid-group-expander{width:" + opts.expanderWidth + "px;text-align:center;padding:0}" + ".datagrid-row-expander{margin:" + Math.floor((opts.groupHeight - 16) / 2) + "px 0;display:inline-block;width:16px;height:16px;cursor:pointer}" + "</style>");
                }
            }
        }
    });
...
(function ($) {
    ...
    var _8ec = $.extend({}, $.fn.datagrid.defaults.view, {
        ...
        onAfterRender: function(target)
        {
            ...
            var _7d4 = $.data(target, "treegrid"),
                opts = _7d4.options;

            // 执行渲染完成后回调
            opts.onAfterRender(target);
        },
...
(function ($) {
    ...
    function _958(_959) {
        ...
        var extra_cls = opts.extraClass ? opts.extraClass : "";
        if (!_95a.panel) {
        ...
        if(opts.minHeight > 0){
            _95a.combo.css("min-height", opts.minHeight);
        }
    }
    ...
    function _96c(e) {
        ...
        switch (e.keyCode) {
            ...
            default:
                if (opts.editable) {
                    if (_96e.timer) {
                        clearInterval(_96e.timer);
                    }
                    _96e.timer = setInterval(function () {
    ...
    $.fn.combo.parseOptions = function (_998) {
        ...
        return $.extend({}, $.fn.textbox.parseOptions(_998), $.parser.parseOptions(_998, ["separator", "panelAlign", {
            ...
            panel_height: t.attr("panel_height") == "auto" ? "auto" : parseInt(t.attr("panel_height")) || undefined,
...
(function ($) {
    ...
    function _99c(_99d, _99e) {
        ...
        var data = _99f.data;
        for (var i = 0; i < data.length; i++) {
            if (data[i][opts.valueField] == _99e || data[i][opts.textField] == _99e) {
                return i;
            }
        }
        return -1;
    ...
    function _9ac(_9b2, _9b3, _9b4) {
        ...
        // 数据源做成字典
        var comb_data = $(_9b2).combobox("getData");
        var comb_map = {};
        comb_data.forEach(function (val) {
            comb_map[val[opts.textField]] = val[opts.valueField];
        });
        ...
        function _b4a(_b4b, a) {
            var item = Strack.getArrayItem(a, opts.valueField, _b4b);
    ...
    function _9c0(_9c1, q) {
        ...
        if (opts.mode == "remote") {
            ...
            _9c4.find('.combobox-item-hover').removeClass('combobox-item-hover');
            _9c4.find('.combobox-item,.combobox-group').hide();
            var data = _9c2.data;
            var vv = [];
            $.map(qq, function (q) {
                q = $.trim(q);
                ...
                for(var i=0; i<data.length; i++){
                    ...
                    if (opts.filter.call(_9c1, q, row)){
                        ...
                        if (opts.groupField && _9c6 != g){
                            opts.finder.getGroupEl(_9c1, g).show();
                            _9c6 = g;
                        }
                    }
                }
    ...
    $.fn.combobox.methods = {
        ...
        getRowValue: function (jq, nkey) {
            //获取一行数据
            var value = $(jq[0]).combobox("getValue"),
                data = $.data(jq[0], "combobox").data;
            if (value) {
                var res = '';
                data.every(function (val) {
                    if (val[nkey] == value) {
                        res = val;
                        return false;
                    }
        ...
        getRowValues: function (jq, nkey) {
            //获取一行数据
            var value = $(jq[0]).combobox("getValues"),
                data = $.data(jq[0], "combobox").data;
            if (value.length>0) {
                var res = [];
                data.forEach(function (val) {
                    if ($.inArray(val[nkey]+'', value)>=0) {
                        res.push(val);
                    }
                });
                return res;
        ...
        appendNewItem : function(jq, item){
            // 添加新选项
            return jq.each(function () {
        ...
        getValue: function (jq) {
            var val = $(jq[0]).combo('getValue');
            var panel = $(jq[0]).combo('panel');
            if (panel.children('div').hasClass('combobox-item-selected')) {
                return val;
            } else {
                return '';
            }
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        inputEvents: $.extend({}, $.fn.combo.defaults.inputEvents, {
            blur: function (e) {
                ...
                if (opts.limitToList && opts.multiple) {
                    var $cp = $(target).parent();
                    var ctext = $cp.find('.textbox-text').val();
                    var _9c9 = $(target).combobox("panel");
                    var item = _9c9.children("div.combobox-item-hover");
                    if (ctext) {
                        _9c7(target);
                    }
        ...
        finder: {
            ...
            getGroupEl:function(target, gvalue){
                ...
                var index = Strack.indexOfArray(state.groups, 'value', gvalue);
    ...
    function _a08(_a09) {
        ...
        $(_a09).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                ...
                dg.datagrid("resize", {
                    width: "100%",
                    height: isNaN(parseInt(opts.panel_height)) ? "auto" : "100%",
...
(function($){
    function create(target){
        ...
        var cls_str = ['tagbox'];
        if(opts.hasDownArrow){
            cls_str.push('tagbox-padding-right');
        }
    ...
    function doEnter(target){
        ...
        if (item.length){
            ...
            if (!opts.limitToList){
                ...
                var values = $(target).tagbox('getValues');
                if (v !== '' && $.inArray(v, values) < 0){
                    if(opts.appendToDB.allow){
                        opts.appendToDB.param["editor"] = "tagbox";
                        $.ajax({
                            type: 'POST',
                            url: StrackPHP['commonAddItem'],
                            data: JSON.stringify({
                                param : opts.appendToDB.param,
                                value : v
                            }),
                            dataType: 'json',
                            contentType: "application/json",
                            success: function (data) {
                                if(parseInt(data["status"]) === 200){
                                    $(target).tagbox('appendNewItem', data["data"]);
                                    values.push(data["data"]["id"]);
                                    $(target).tagbox('setValues', values);
                                }
                            }
                        });
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        ...
        keyHandler: $.extend({}, $.fn.combobox.defaults.keyHandler, {
            ...
            query: function(q,e){
                ...
                if (opts.limitToList || opts.allowInput){
        ...
        if (!_a3e.calendar) {
            ...
            $.extend(_a3e.calendar.calendar("options"), {
                ...
                onSelect: function (date) {
                    ...
                    if(opts.start_limit){
                        // 限制开始时间
                        $("#"+opts.start_limit).datebox('calendar').calendar({
                            validator: function(n_date){
                                return n_date<=date;
                            }
                        });
                    }
                    ...
                    if(opts.end_limit){
                        // 限制结束时间
                        $("#"+opts.end_limit).datebox('calendar').calendar({
                            validator: function(n_date){
                                return n_date>=date;
                            }
                        });
...
(function ($) {
    ...
    function _a9d(_a9e) {
        ...
        _aa1.append('<div class="slider-range"></div>');
