$(function () {
    obj = {
        ...
        // 添加固定表数据
        create_horizontal_related: function(i){
            var lang = $(i).data("lang");
            ...
            Strack.item_operate_dialog(lang,
                {
                    mode: "create_related",
                    field_list_type: ['edit'],
                    from_item_id: h_param['src_link_id'],
                    from_module_id: h_param["src_module_id"],
                    module_id: h_param["dst_module_id"],
                    project_id: h_param["project_id"],
                    horizontal_type : h_param["horizontal_type"],
                    variable_id : h_param["variable_id"],
                    page: single_grid_param["page"],
                    schema_page: single_grid_param["schema_page"],
                    type: "add_panel",
                    keep_panel: true
        ...
        delete_single_grid_data: function (i) {
            ...
            var single_grid_param_delete = Strack.deep_copy(single_grid_param);
            single_grid_param_delete['from_module_id']  = 0;
            single_grid_param_delete['from_item_id']  = 0;
            Strack.ajax_grid_delete('single_main_datagrid_box', 'id', StrackLang[lang], StrackPHP['deleteGridData'], single_grid_param_delete);
        },
        // 重置固定表格类型数据表格
    ...
    function switch_tab_page(tab_param) {
        ...
        switch (tab_param.type) {
            ...
            case "be_horizontal_relationship":
                ...
                if(tab_param.type === "horizontal_relationship"){
                    horizontal_param["module_id"] = tab_param["dst_module_id"];
                    horizontal_param["module_code"] = tab_param["dst_module_code"];
                }else {
                    horizontal_param["module_id"] = tab_param["module_id"];
                    horizontal_param["dst_module_id"] = tab_param["module_id"];
                    horizontal_param["module_code"] = tab_param["module_code"];
                }
            ...
            case "entity_child":
                ...
                entity_child_param['src_module_id'] = entity_child_param['dst_module_id'];
                entity_child_param['dst_module_id'] = entity_child_param['module_id'];
            ...
            case "other_page":
                ...
                Strack.check_cloud_disk_endpoints('#tab_iframe_page', {
                    dom_id: '#tab_iframe_page',
                    type : 'task',
    ...
    function set_horizontal_relationship_bnt_param(pos, tab_param, horizontal_type) {
        if(horizontal_type === "be_horizontal_relationship"){
            ...
            $("#single_grid_related_horizontal").hide();
        }else {
            if(pos === "entity"){
                ...
                $("#single_grid_create_bnt").hide();
                $("#single_create_horizontal_bnt,#single_related_horizontal_bnt").attr("srcmoduleid", tab_param["src_module_id"])
                    .attr("dstmoduleid", tab_param["dst_module_id"])
                    .attr("dstmodulecode", tab_param["dst_module_code"])
                    .attr("variableid", tab_param["variable_id"])
                    .attr("horizontaltype", horizontal_type)
                ...
                $("#single_grid_related_horizontal").show();
            }
        }
    }
    ...
    function load_info_panel() {
        ...
        Strack.G.mainfieldsRequestParam = {
            id: "#details_info",
            mask: 'main_info',
            pos: 'max',
            url: StrackPHP["getModuleItemInfo"],
        ...
        Strack.load_info_panel(Strack.G.mainfieldsRequestParam, function (data) {
            Strack.set_info_main_show_mode_dom('details_main_info_title', data['fields_show_mode']);
        });
    }
