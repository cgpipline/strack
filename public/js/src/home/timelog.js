$(function () {
    obj = {
        ...
        // 删除timelog数据
        delete_timelog: function (i) {
            Strack.ajax_grid_delete('main_datagrid_box', 'id', StrackLang['Delete_Timelog_Notice'], StrackPHP['deleteGridData'], param);
        },
        // 重置timelog数据表格
        ...
        Strack.load_grid_columns('#table_grid', {
            ...
            var filter_data = {
                filter: {
                    ...
                    request: [
                        {field : 'project_id', field_type : 'built_in', editor:"combobox", value : param.project_id, condition : 'EQ', module_code : param.module_code, table : 'Timelog'}
                    ],
            ...
            // datagrid 配置参数
            var gird_param = {
                url: TimelogPHP['getTimelogGridData'],
