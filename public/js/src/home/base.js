$(function () {
    obj = {
        ...
        base_delete: function (i) {
            Strack.ajax_grid_delete('main_datagrid_box', 'id', StrackLang['Delete_Base_Notice'], StrackPHP['deleteGridData'], param);
        },
        // 重置base数据表格
        reset_base: function () {
        ...
        Strack.load_grid_columns('#grid_datagrid_main', {
            ...
            var filter_data = {
                filter: {
                    ...
                    request: [
                        {field : 'project_id', field_type : 'built_in', editor:"combobox", value : param.project_id, condition : 'EQ', module_code : param.module_code, table : 'Base'}
                    ],
            ...
            var gird_param = {
                ...
                onDblClickRow: function (index, row) {
                    ...
                    param["entity_id"] = row["base_entity_id"];
