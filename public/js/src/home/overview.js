        ...
        Strack.load_grid_columns('#team_datagrid_main', {
            ...
            var filter_data = {
                filter: {
                    ...
                    request: [
                        {field : 'project_id', field_type : 'built_in', editor:"combobox", value : param.project_id, condition : 'EQ', module_code : 'project_member', table : 'ProjectMember'}
                    ],
                ...
                schema_page: 'project_member',
                module_id: param["project_member_module_id"],
                module_type: param["project_member_module_type"],
                module_code: param["project_member_module_code"],
                project_id: param["project_id"]
            };
            // datagrid 配置参数
            var gird_param = {
