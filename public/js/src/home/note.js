$(function () {
    obj = {
        ...
        // 删除note数据
        note_delete: function (i) {
            Strack.ajax_grid_delete('main_datagrid_box', 'id', StrackLang['Delete_Note_Notice'], StrackPHP['deleteGridData'], param);
        },
        // 重置note数据表格
        reset_note: function () {
        ...
        Strack.load_grid_columns('#table_grid', {
            ...
            var filter_data = {
                filter: {
                    ...
                    request: [
                        {field : 'project_id', field_type : 'built_in', editor:"combobox", value : param.project_id, condition : 'EQ', module_code : param.module_code, table : 'Note'}
                    ],
