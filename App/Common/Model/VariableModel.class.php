...
class VariableModel extends RelationModel
{
    ...
    protected $_validate = [
        ...
        ['module_id,code', '', '{%Variable_Code_Exist}', self::MUST_VALIDATE, 'unique', self::MODEL_BOTH],
        ['type', '', '', self::MUST_VALIDATE, 'require', self::MODEL_INSERT],//必须字段
        ['type', ['text', 'checkbox', 'textarea', 'combobox', 'datebox', 'datetimebox', 'belong_to', 'expression', 'horizontal_relationship', 'timespinner'], '', self::EXISTS_VALIDATE, 'in'],
