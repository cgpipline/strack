...
<block name="head-css">
    <script type="text/javascript">
        var SignMethodPHP = {
            ...
            'saveLoginMethodSetting' : '{:U("Admin/Ldap/saveLoginMethodSetting")}',
        };
...
<block name="admin-main">
    ...
    <div id="active-login_method" class="admin-content-wrap">
        ...
        <div class="ad-srd-wrap">
            <div class="ad-srd-title">
                {$Think.lang.Strack_Union_Setting}
            </div>
        </div>
        <div class="admin-ui-full">
            <div class="form-group">
                <label class="stcol-lg-1 control-label">{$Think.lang.Open_Strack_Union_Setting}</label>
                <div class="stcol-lg-2">
                    <div class="bs-component">
                        <if condition="$view_rules.switch == 'yes' ">
                            <input id="open_strack_union_login" autocomplete="off"/>
                            <else/>
                            <input id="open_strack_union_login" class="form-input" data-options="disabled:true">
                        </if>
                    </div>
                </div>
            </div>
        ...
        <div class="ad-srd-wrap">
            <div class="ad-srd-title">
                {$Think.lang.QQ_Login_Setting}
            </div>
        </div>
        <div class="admin-ui-full">
            <div class="form-group">
                <label class="stcol-lg-1 control-label">{$Think.lang.Open_QQ_Login_Login}</label>
                <div class="stcol-lg-2">
                    <div class="bs-component">
                        <if condition="$view_rules.switch == 'yes' ">
                            <input id="open_qq_login" autocomplete="off"/>
                            <else/>
                            <input id="open_qq_login" class="form-input" data-options="disabled:true">
                        </if>
                    </div>
                </div>
            </div>
