                                ...
                                <div id="temp_set_fixed" class="temp-set-main">
                                    ...
                                    <div id="temp_base_tfield" class="st-workflowsummary">
                                        <div class="st-property-header">
                                            <div class="st-property-name">
                                                <i class="icon-uniE92E icon-left"></i>
                                                {$Think.lang.Template_Details_Main_Field}
                                            </div>
                                            <div class="st-property-button">
                                                <a id="fixed_top_field" href="javascript:;" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="obj.template_set_field(this);" data-category="main_field" data-title="{$Think.lang.Template_Details_Main_Field}">
                                                    {$Think.lang.Edit}
                                                </a>
                                            </div>
                                        </div>
                                        <div class="st-property-info">
                                            <p>{$Think.lang.Template_Details_Main_Field_Notice}</p>
                                        </div>
                                    </div>
                                ...
                                <div id="temp_set_entity" class="temp-set-main">
                                    ...
                                    <div class="st-workflowsummary">
                                        <div class="st-property-header">
                                            ...
                                            <div class="st-property-button">
                                                <a id="entity_top_field" href="javascript:;" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="obj.template_set_field(this);" data-category="main_field" data-title="{$Think.lang.Template_Details_Main_Field}">
                                                    {$Think.lang.Edit}
                                                </a>
                                            </div>
                                        </div>
