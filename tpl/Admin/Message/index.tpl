...
<block name="admin-main">
  <div id="active-message" class="admin-content-wrap">
    ...
    <div class="admin-ui-full">
      ...
      <div class="ad-srd-wrap">
        <div class="ad-srd-title">
          {$Think.lang.Task_Reminder_Settings}
        </div>
      </div>

      <div class="form-group">
        <label class="stcol-lg-1 control-label">{$Think.lang.Task_Reminder_Before_Five_Min_Settings}</label>
        <div class="stcol-lg-2">
          <div class="bs-component">
            <if condition="$view_rules.submit == 'yes' ">
              <input id="task_reminder_before_five_min" class="open-switch" />
              <else/>
              <input id="task_reminder_before_five_min" class="form-input" data-options="disabled:true">
            </if>
          </div>
        </div>
      </div>
