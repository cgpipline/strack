    ...
    <div id="active-role" class="admin-content-dept">
                    ...
                    <div class="ad-left-search">
                        <div class="ui search aign-right">
                            <div class="ui icon input">
                                ...
                                <input id="search_val" class="prompt" placeholder="{$Think.lang.Search_More}"
                                       type="text" autocomplete="off">
                                <a href="javascript:;" id="search_auth_role" class="st-filter-action"
                                   onclick="obj.auth_role_filter(this);">
        ...
        <div class="admin-temp-right">
            <div id="hide_role_param">
                ...
                <input id="hide_role_auth_param" type="hidden" name="auth_param">
                ...
                <div class="temp-setlists">
                    ...
                    <div class="admin-temp-tab">
                        <div class="ui secondary pointing menu">
                            ...
                            <a href="javascript:;" class="item group-item" onclick="obj.select_role_tab(this)" data-tab="data_range">{$Think.lang.Data_Range}</a>
                        </div>
                    </div>

                    <div id="page_auth_panel" class="ui tab admin-group-content group-no-input">

                        <div class="temp-content-left admin-temp-list">
                    ...
                    <div id="field_auth_panel" class="ui tab admin-group-content group-no-input">
                        ...
                        <div id="content_right_field" class="temp-content-right">
                            ...
                            <div class="temp-content-right-wrap">
                                ...
                                <div class="admin-temp-tab">
                                    <div class="ui secondary pointing menu">
                                        <a href="javascript:;" class="item group-rule-item active" data-tab="field">{$Think.lang.Field_Authority}</a>
                                    </div>
                                </div>
                    ...
                    <div id="data_range_panel" class="ui tab admin-group-content group-no-input">
                        <div class="temp-content-left admin-temp-list">
                            <ul id="data_range_module_list" class="module-list">
                                <!--固定可以配置权限模块列表-->
                            </ul>
                        </div>
                        <div id="content_right_data_range" class="temp-content-right">
                            <div class="temp-content-right-no">
                                <p>{$Think.lang.Please_Select_One_Module}</p>
                            </div>
                            <div class="temp-content-right-wrap">
                                ...
                                <div id="data_range_rules_list" class="role-set-wrap role-rule-wrap">
                                    <!--数据范围、权限规则-->
                                </div>
                            </div>
                        </div>
