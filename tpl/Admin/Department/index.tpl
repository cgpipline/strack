...
<block name="head-css">
  <script type="text/javascript">
    var DeptPHP = {
      ...
      'getDepartmentTreeList': '{:U("Admin/Department/getDepartmentTreeList")}',
      'getDepartmentGridData' : '{:U("Admin/Department/getDepartmentGridData")}',
      'getProjectMemberCombobox' : '{:U("Admin/Department/getProjectMemberCombobox")}'
    };
        ...
        <div class="dept-form-wrap">
          ...
          <form id="add_dept" >
            ...
            <div class="form-field form-required required term-name-wrap">
              <label for="status_icon">{$Think.lang.Belong_Department}</label>
              <if condition="$view_rules.submit == 'yes' ">
                <input id="dept_belong" class="form-input" autocomplete="off" wiget-type="combotree" wiget-need="yes" wiget-field="parent_id" wiget-name="{$Think.lang.Belong_Department}">
                <else/>
                <input id="dept_belong" class="form-input" data-options="disabled:true">
              </if>
            </div>
            <div class="form-field form-required term-name-wrap">
              <label for="status_icon">{$Think.lang.Department_Maneger}</label>
              <if condition="$view_rules.submit == 'yes' ">
                <input id="dept_maneger" class="form-input" autocomplete="off" wiget-type="combobox_s" wiget-need="no" wiget-field="user_ids" wiget-name="{$Think.lang.Department_Maneger}">
                <else/>
                <input id="dept_maneger" class="form-input" data-options="disabled:true">
              </if>
            </div>
