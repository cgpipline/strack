...
<div id="import_excel_step" class="import-excel-main step-body">
        ...
        <div id="import_ex_list" class="step-content-wrap step-content">
            <div class="step-list step-full-wrap">
                ...
                <div class="ui two column grid select-excel-method">
                    <div class="column">
                        <a href="javascript:;" class="import-excel-card"
                           onclick="Strack.select_import_excel_method(this)" data-method="paste">
                    ...
                    <div class="column">
                        <a href="javascript:;" class="import-excel-card"
                           onclick="Strack.select_import_excel_method(this)" data-method="file">
                            <div class="excel-card-title">
                                <div class="main">
                ...
                <div class="import-method-wrap">
                    <div id="excel_format_paste" class="import-method-panel import-method-paste" style="display: none">
                        ...
                        <div class="import-method-swicth">
                            {$Think.lang.Exist_Header}：<input id="method_paste_header" name="method_paste_header"
                                                              autocomplete="off"/>
                        </div>
                        <textarea id="import_method_paste" class="form-control-excel form-input" autocomplete="off"
                                  placeholder="文本框"></textarea>
                    </div>
                    <div id="excel_format_file" class="import-method-panel import-method-file" style="display: none">
                        ...
                        <div class="import-method-swicth">
                            {$Think.lang.Exist_Header}：<input id="method_file_header" name="method_file_header"
                                                              autocomplete="off"/>
                        </div>
    ...
    <div class="project-step-bnt">
        <div class="step-bnt-footer">
            ...
            <a id="import_excel_bnt_prev" href="javascript:;" class="st-dialog-button st-button-base button-dgsub"
               onclick="Strack.import_excel_step_prev();" style="display: none">{$Think.lang.Previous}</a>
            <a id="import_excel_bnt_next" href="javascript:;" class="st-dialog-button st-button-base button-dgsub"
               onclick="Strack.import_excel_step_next();">{$Think.lang.Next}</a>
            <a id="import_excel_bnt_submit" href="javascript:;" class="st-dialog-button st-button-base button-dgsub"
               onclick="Strack.close_import_excel_panel();" style="display: none">{$Think.lang.Done}</a>
        </div>
    </div>
</div>
