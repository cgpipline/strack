            ...
            <div class="center aligned two column row title">
                ...
                <div class="wide column tab">
                    <div class="item-breadcrumb-right">
                        <a href="javascript:;" id="grid_slider_af_settlement_bnt" class="ui button orange" onclick="Strack.application_for_settlement(this, event)" data-linkid="" data-moduleid="" data-from="grid" title="">
                            {$Think.lang.Application_For_Settlement}
                        </a>
                        <a href="javascript:;" id="grid_slider_jj_settlement_bnt" class="ui button red" onclick="Strack.reject_for_settlement(this, event)" data-linkid=""  data-moduleid="" data-from="grid" title="">
                            {$Think.lang.Reject_For_Settlement}
                        </a>
                        <a href="javascript:;" id="grid_slider_cf_settlement_bnt" class="ui button green" onclick="Strack.confirmation_for_settlement(this, event)" data-linkid="" data-moduleid="" data-from="grid"  title="">
                            {$Think.lang.Confirmation_For_Settlement}
                        </a>

                        <a href="javascript:;" id="grid_slider_tg_bnt" class="ui button" onclick="Strack.item_start_timelog(this, event)" data-linkid="" data-timelogid="0" data-moduleid="" title="" data-id="grid_slider_tg_bnt" >
    ...
    <div class="grid-slider-main">
        ...
        <div id="grid_slider_tab_info" class="ui tab pitem-wrap overflow-auto" data-tab="info">
            <div class="task-info-dropdown">
                <div id="grid_slider_main_info_title"  class="ui dropdown st-dropdown">
                    <div class="info-down-title aign-left">
                        {$Think.lang.All_Info}
                    </div>
                    <i class="dropdown icon"></i>
                    <div id="datagrid_main_fields_config" class="menu" data-id="" data-page=""  data-moduleid="" data-modulecode="" data-projectid="" data-templateid ="">
                        <a href='javascript:;' class="item important" onclick="Strack.main_fields_config(this);"  data-pos="slider" data-type="important">{$Think.lang.Important_Info}</a>
                        <a href='javascript:;' class="item all" onclick="Strack.main_fields_config(this);" data-pos="slider" data-type="all">{$Think.lang.All_Info}</a>
                        <div class="divider"></div>
                        <a href='javascript:;' class="item" onclick="Strack.main_fields_config(this);"  data-pos="slider" data-type="setting">{$Think.lang.Important_Info_Setting}</a>
                    </div>
                </div>
            </div>
        ...
        <div id="grid_slider_tab_table" class="ui tab pitem-wrap" data-tab="table">
            <div class="grid-slider-tab-table">
                ...
                <div id="grid_slider_tb" style="padding:5px;">
                    <a href="javascript:;" id="grid_slider_datagrid_add_bnt" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="Strack.add_grid_slider_item(this);">
                        {$Think.lang.Add}
                    </a>
