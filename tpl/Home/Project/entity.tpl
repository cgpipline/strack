...
<block name="head-title"><title>{$module_title}</title></block>

<block name="head-js">
    <if condition="$is_dev == '1' ">
        <script type="text/javascript" src="__JS__/src/home/entity.js"></script>
        <else/>
        <script type="text/javascript" src="__JS__/build/home/entity.min.js"></script>
    </if>
</block>
<block name="head-css">
    <script type="text/javascript">
        var EntityPHP = {
            'getEntityGridData' : '{:U('Home/Entity/getEntityGridData')}',
            'deleteEntity' : '{:U('Home/Entity/deleteEntity')}'
        };
        // 当前页面参数
                ...
                <div id="tb_grid" class="proj-tb tb-padding-grid grid-toolbar" data-grid="main_datagrid_box" data-page="{$page}" data-schemapage="{$page}" data-moduleid="{$module_id}" data-maindom="grid_datagrid_main" data-bardom="grid_filter_main" data-projectid="{$project_id}">
                    ...
                    <eq name="view_rules.toolbar__create" value="yes">
                        <div class="st-buttons-sig st-buttons-blue aign-left">
                            <a href='javascript:;' onclick="obj.entity_add(this);" data-lang="{$module_name}">
                                <i class="icon plus"></i>
                        ...
                        <div class="ui dropdown st-dropdown aign-left">
                            ...
                            <div class="menu edit-menu">
                                ...
                                <eq name="view_rules.toolbar__edit__batch_edit" value="yes">
                                    <a href="javascript:;" class="item" onclick="obj.entity_edit(this);" data-lang="{$Think.lang.Batch_Edit}">
                                        <i class="icon-uniF044 icon-left"></i>
                                        {$Think.lang.Edit_Selected}
                                    </a>
                                </eq>

                                <eq name="view_rules.toolbar__edit__add_task" value="yes">
                                    <a href="javascript:;" class="item" onclick="Strack.entity_add_task(this);" data-lang="{$module_name}" data-modulecode="{$module_code}" data-taskmoduleid="{$task_module_id}" data-schemapage="{$page}">
                                        <i class="icon-uniF046 icon-left"></i>
                                        {$Think.lang.Add_Task}
                                    </a>
                                </eq>
                                ...
                                <eq name="view_rules.toolbar__edit__batch_delete" value="yes">
                                    <div class="divider"></div>
                                    <a href="javascript:;" class="item" onclick="obj.entity_delete(this);">
                    ...
                    <eq name="view_rules.toolbar__step" value="yes">
                        <div class="ui dropdown st-dropdown aign-left">
