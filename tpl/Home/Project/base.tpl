            ...
            <div id="grid_datagrid_main" class="entity-datalist base-m-grid">
                <div id="tb_grid" class="proj-tb tb-padding-grid grid-toolbar" data-grid="main_datagrid_box" data-page="{$page}" data-schemapage="{$page}" data-moduleid="{$module_id}" data-maindom="grid_datagrid_main" data-bardom="grid_filter_main" data-projectid="{$project_id}">
                    ...
                    <eq name="view_rules.toolbar__edit" value="yes">
                        <div class="ui dropdown st-dropdown aign-left grid-tool-item" style="display: none;">
                    ...
                    <div class="kanban-mode-list" style="display: none;">
                        <!--分组看板支持视图列表-->
                    </div>

                    <div class="ui search st-buttons-sig aign-right" style="margin-left: 20px">
                        <a href="javascript:;" class="ui blue basic button view-kanban-mode grid_view_mode" onclick="Strack.click_view_mode_item(this)" data-panel="grid" from="view_mode" view_mode=""></a>
                    </div>
