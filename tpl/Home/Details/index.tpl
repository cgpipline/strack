                ...
                <div class="center aligned three column row title">
                    ...
                    <div class="wide column tab">
                        ...
                        <div class="item-breadcrumb-right">
                            ...
                            <eq name="af_settlement_bnt" value="yes">
                                <a href="javascript:;" id="detail_slider_af_settlement_bnt" class="ui button orange settlement_bnt_af_{$item_id}" onclick="Strack.application_for_settlement(this, event)" data-linkid="{$item_id}" data-moduleid="{$module_id}" data-from="detail" data-eq="{$assignee_eq_reviewed}" title="">
                                    {$af_settlement_bnt_lang}
                                </a>
                            </eq>
                            <eq name="jj_settlement_bnt" value="yes">
                                <a href="javascript:;" id="detail_slider_jj_settlement_bnt" class="ui button red settlement_bnt_jj_{$item_id}" onclick="Strack.reject_for_settlement(this, event)" data-linkid="{$item_id}"  data-moduleid="{$module_id}" data-from="detail" data-eq="{$assignee_eq_reviewed}" title="">
                                    {$Think.lang.Reject_For_Settlement}
                                </a>
                            </eq>
                            <eq name="cf_settlement_bnt" value="yes">
                                <a href="javascript:;" id="detail_slider_cf_settlement_bnt" class="ui button green settlement_bnt_cf_{$item_id}" onclick="Strack.confirmation_for_settlement(this, event)" data-linkid="{$item_id}" data-moduleid="{$module_id}" data-from="detail" data-eq="{$assignee_eq_reviewed}" title="">
                                    {$Think.lang.Confirmation_For_Settlement}
                                </a>
                            </eq>

                            <if condition="($module_id eq 4) AND ($is_my_task eq 'yes') AND ($view_rules.top_panel__timelog eq 'yes') ">
                                <a href="javascript:;" id="top_timelog_bnt" class="ui timelog-bnt button" onclick="Strack.item_start_timelog(this, event)" data-id="top_timelog_bnt" data-linkid="{$item_id}" data-timelogid="0" data-moduleid="{$module_id}" title=" {$Think.lang.Time_Log}">
        ...
        <div class="details-page-main task-mainwrap">
            ...
            <div id="tab_info"  class="ui tab pitem-wrap" data-tab="info">
                <div class="task-info-dropdown">
                    <div id="details_main_info_title"  class="ui dropdown st-dropdown">
                        <div class="info-down-title aign-left">
                            {$Think.lang.All_Info}
                        </div>
                        <i class="dropdown icon"></i>
                        <div class="menu" data-page="{$page}"  data-moduleid="{$module_id}" data-modulecode="{$module_code}" data-projectid="{$project_id}" data-templateid ="{$template_id}">
                            <a href='javascript:;' class="item important" onclick="Strack.main_fields_config(this);"  data-pos="details" data-type="important">{$Think.lang.Important_Info}</a>
                            <a href='javascript:;' class="item all" onclick="Strack.main_fields_config(this);" data-pos="details" data-type="all">{$Think.lang.All_Info}</a>
                            <div class="divider"></div>
                            <eq name="view_rules.top_panel__fields_rules" value="yes">
                                <a href='javascript:;' class="item" onclick="Strack.main_fields_config(this);"  data-pos="details" data-type="setting">{$Think.lang.Important_Info_Setting}</a>
                            </eq>
                        </div>
                    </div>
                </div>
                ...
                <div id="single_datagrid_main" class="entity-datalist base-m-grid">
                    <div id="single_tb_grid" class="proj-tb tb-padding-grid grid-toolbar" data-grid="single_main_datagrid_box" data-page="" data-schemapage="" data-moduleid="" data-maindom="single_datagrid_main" data-bardom="single_filter_main" data-projectid="{$project_id}">
                        ...
                        <eq name="view_rules.tab_bar__horizontal_relationship__toolbar__create" value="yes">
                            <div id="single_grid_related_horizontal"  class="st-buttons-sig st-buttons-blue aign-left" style="display: none;margin-right: 10px">
                                <a href='javascript:;' id="single_related_horizontal_bnt" class="create-bnt" onclick="obj.create_horizontal_related(this);" data-variableid="" data-srcmoduleid="" data-dstmoduleid="" data-srclinkid="">
                                    <i class="icon plus"></i>
                                    <span class="stp-title"></span>
                                </a>
                            </div>
                            <div id="single_grid_create_horizontal"  class="st-buttons-sig st-buttons-green aign-left" style="display: none">
                                <a href='javascript:;' id="single_create_horizontal_bnt" class="related-bnt" onclick="Strack.create_horizontal_relationship(this);" data-variableid="" data-srcmoduleid="" data-dstmoduleid="" data-srclinkid="">
                                    <i class="icon-uniE61E"></i>
                                    <span class="stp-title"></span>
                                </a>
                            </div>
                        </eq>
