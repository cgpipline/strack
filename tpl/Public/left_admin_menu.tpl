...
<ul class="nav sidebar-menu">
    ...
    <div id="sidebar-admin-20" class="sidebar-nav nav-show">
        ...
        <if condition="$admin_menu.fieldSettings == 'yes' AND $show_theme eq 'fdc'">
            <li id="admin_fieldSettings">
                <a href="{:U('/admin/fieldSettings')}" onclick="Strack.click_admin_menu(this)">
                    ...
                    <span class="sidebar-title">{$Think.lang.Field_Settings}</span>
                </a>
            </li>
        </if>
        ...
        <if condition="$admin_menu.dingTalk == 'yes' ">
            <li id="admin_dingtalk">
                <a href="{:U('/admin/dingTalk')}" onclick="Strack.click_admin_menu(this)">
                    <span class="icon-uniF1A6"></span>
                    <span class="sidebar-title">{$Think.lang.Admin_Dingtalk}</span>
                </a>
            </li>
        </if>
    </div>
    ...
    <div id="sidebar-admin-50" class="sidebar-nav nav-show">
        ...
        <if condition="$admin_menu.projectModule == 'yes' ">
            <li id="admin_projectModule">
                <a href="{:U('/admin/projectModule')}" onclick="Strack.click_admin_menu(this)">
                    <span class="icon-uniE61D"></span>
                    <span class="sidebar-title">{$Think.lang.Project_Module_Setting}</span>
                </a>
            </li>
        </if>
    </div>
