            ...
            columns: [[
                ...
                {field: 'editor', title: StrackLang['Editor'], align: 'center', width: 140, frozen:"frozen", findex:8, editor:{
                    ...
                    options:{
                        ...
                        textField:'name',
                        method:'post',
                        data: [{id:'none',name:'none'}, {id:'text',name:'text'}, {id:'checkbox',name:'checkbox'}, {id:'textarea',name:'textarea'}, {id:'combobox',name:'combobox'}, {id:'datebox',name:'datebox'}, {id:'datetimebox',name:'datetimebox'}, {id:'upload', name:'upload'}, {id:'relation', name:'relation'}, {id:'tagbox', name:'tagbox'}, {id:'timespinner', name:'timespinner'}, {id:'task_repeat', name:'task_repeat'}]
                    }
                }},
                ...
                {field: 'outreach_editor', title: StrackLang['Outreach_Editor'], align: 'center', width: 120, frozen:"frozen", findex:31, editor: {
                    ...
                    options:{
                        ...
                        textField:'name',
                        method:'post',
                        data: [{id:'none',name:'none'}, {id:'input',name:'input'}, {id:'checkbox',name:'checkbox'}, {id:'textarea',name:'textarea'}, {id:'combobox',name:'combobox'}, {id:'datebox',name:'datebox'}, {id:'datetimebox',name:'datetimebox'}, {id:'upload', name:'upload'}, {id:'relation', name:'relation'}, {id:'tagbox', name:'tagbox'}, {id:'task_repeat', name:'task_repeat'}]
                    }
                }},
