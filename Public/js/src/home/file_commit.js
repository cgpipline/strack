        ...
        Strack.load_grid_columns('#table_grid', {
            ...
            var filter_data = {
                filter: {
                    ...
                    request: [
                        {field : 'project_id', field_type : 'built_in', editor:"combobox", value : param.project_id, condition : 'EQ', module_code : param.module_code, table : 'FileCommit'}
                    ],
            ...
            // datagrid 配置参数
            var gird_param = {
                url: FileCommitPHP['getFileCommitGridData'],
