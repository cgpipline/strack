$(function () {
    obj = {
        ...
        // 删除onset数据
        onset_delete: function (i) {
            Strack.ajax_grid_delete('main_datagrid_box', 'id', StrackLang['Delete_Onset_Notice'], StrackPHP['deleteGridData'], param);
        },
        // 重置onset数据表格
        reset_onset: function () {
        ...
        Strack.load_grid_columns('#table_grid', {
            ...
            var filter_data = {
                filter: {
                    ...
                    request: [
                        {field : 'project_id', field_type : 'built_in', editor:"combobox", value : param.project_id, condition : 'EQ', module_code : param.module_code, table : 'Onset'}
                    ],
