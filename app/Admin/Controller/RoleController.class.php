    ...
    public function getAuthPageModuleData()
    {
        ...
        switch ($param["tab"]) {
            case "project":
                ...
                break;
            case "front":
                $moduleData = $authService->getAuthPageModuleData("front,top_panel,top_main_menu");
                break;
            case "admin":
            ...
            case "data_range":
                // 获取数据范围可配置模块
                $moduleData = $authService->getAuthPageDataRangeModuleData();
                break;
        }
    ...
    public function getAuthModuleRules()
    {
        ...
        switch ($param["mode"]) {
            case 'field':
                ...
                break;
            case 'data_range':
                $resData = $authService->getAuthDataRangeRules($param);
                break;
            default:
