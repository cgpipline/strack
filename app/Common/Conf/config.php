...
return array(
    ...
    //缓存文件前缀
    'DATA_CACHE_KEY' => 'cgmes@weijer_2018',
    ...
    'QQ_CONFIG' => [
        ...
        'app_key' => Env::get("qq_app_key"),
        'callback_url' => Env::get("qq_callback_url")
    ],

    // strack联合账户登录
    'STRACK_UNION_CONFIG' => [
        'base_url' => Env::get("strack_oauth_rul"),
        'app_key' => Env::get("strack_oauth_app_key"),
        'app_secret' => Env::get("strack_oauth_app_secret"),
