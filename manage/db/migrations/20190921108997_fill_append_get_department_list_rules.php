...
class FillAppendGetDepartmentListRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $authNode = [
            'name' => '获取部门树列表',
            'code' => 'get_department_tree_list',
            'lang' => 'Get_Department_Tree_List',
            'type' => 'route',
            'module' => 'page',
            'project_id' => 0,
            'module_id' => 0,
            'rules' => 'Admin/Department/getDepartmentTreeList',
