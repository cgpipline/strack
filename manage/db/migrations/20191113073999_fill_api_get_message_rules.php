...
class FillApiGetMessageRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $getSideInboxDataNodeRows = [
            [
                ...
                'project_id' => '0',
                'module_id' => '0',
                'rules' => 'api/Event/getSideInboxData',
                'uuid' => Webpatser\Uuid\Uuid::generate()->string
            ]
        ];


        $this->table('strack_auth_node')->insert($getSideInboxDataNodeRows)->save();
        ...
        $this->savePageAuth($getSideInboxListPageAuthRows);
    }
