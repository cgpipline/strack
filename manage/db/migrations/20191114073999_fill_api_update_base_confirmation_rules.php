...
class FillApiUpdateBaseConfirmationRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $getTaskStatusListNodeRows = [
            [
                ...
                'project_id' => '0',
                'module_id' => '0',
                'rules' => 'api/Event/updateBaseConfirmationData',
        ...
        $getTaskStatusListPageAuthRows = [
            'page' => [
                ...
                'lang' => 'Update_Base_Confirmation_Data',
                'page' => 'api_event',
                'param' => 'updatebaseconfirmationdata',
                'type' => 'belong',
                'parent_id' => 0,
                'uuid' => Webpatser\Uuid\Uuid::generate()->string
            ],
        ...
        $this->savePageAuth($getTaskStatusListPageAuthRows, 1193);
    }
