...
class FillApiTaskGetStatusRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $getTaskStatusListNodeRows = [
            [
                'name' => '获取任务状态列表',
                'code' => 'get_task_status_list',
                'lang' => 'Get_Task_Status_List',
                'type' => 'route',
                'module' => 'api',
                'project_id' => '0',
                'module_id' => '0',
                'rules' => 'api/Task/getTaskStatusList',
