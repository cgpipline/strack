...
class FillAppendGetAttributeRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $authNode = [
            'name' => '获取数据属性数据',
            'code' => 'get_file_attribute_data',
            'lang' => 'Get_File_Attribute_Data',
            'type' => 'route',
            'module' => 'api',
            'project_id' => 0,
            'module_id' => 0,
            'rules' => 'api/Project/getFileAttributeData',
