...
class CreateDepartmentManageTable extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('strack_department_manage', ['id' => false, 'primary_key' => ['id'], 'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci']);

        //添加数据字段
        $table->addColumn('id', 'integer', ['identity' => true, 'signed' => false, 'limit' => 11, 'comment' => '主键ID'])
            ->addColumn('department_id', 'integer', ['signed' => false, 'default' => 0, 'limit' => 11, 'comment' => '部门ID'])
