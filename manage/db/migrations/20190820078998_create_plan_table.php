...
class CreatePlanTable extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('strack_plan', ['id' => false, 'primary_key' => ['id'], 'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci']);

        //添加数据字段
        $table->addColumn('id', 'integer', ['identity' => true, 'signed' => false, 'limit' => 11, 'comment' => '计划ID'])
            ->addColumn('lock', 'enum', ['values' => 'yes,no', 'default' => 'no', 'comment' => '锁定状态'])
            ...
            ->addColumn('end_time', 'integer', ['signed' => false, 'default' => 0, 'limit' => 11, 'comment' => '截至时间'])
            ->addColumn('created_by', 'integer', ['signed' => false, 'default' => 0, 'limit' => 11, 'comment' => '创建用户ID'])
