...
class FillCheckCloudDiskRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $authNode = [
            'name' => '前端判断网盘服务器是否可用',
            'code' => 'frontend_check_could_disk_server',
            'lang' => 'Frontend_Check_Could_Disk_Server',
            'type' => 'route',
            'module' => 'page',
            'project_id' => 0,
            'module_id' => 0,
            'public' => 'yes',
            'rules' => 'Home/View/frontendCheckCouldDiskServer',
