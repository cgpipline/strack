...
class FillApiUserCenterRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $authNodeRows = [
                [
                'name' => '获取用户项目任务数据',
                'code' => 'get_project_tasks_data',
                'lang' => 'get_project_tasks_data',
                'type' => 'route',
                'module' => 'api',
                'project_id' => '0',
                'module_id' => '0',
                'public' => 'yes',
                'rules' => 'api/User/getProjectTasksData',
                'uuid' => Webpatser\Uuid\Uuid::generate()->string
            ],
            [
                'name' => '获取用户积分信息',
                'code' => 'get_integral_list',
                'lang' => 'get_integral_list',
                'type' => 'route',
                'module' => 'api',
                'project_id' => '0',
                'module_id' => '0',
                'public' => 'yes',
                'rules' => 'api/User/getIntegralList',
                'uuid' => Webpatser\Uuid\Uuid::generate()->string
            ]
        ];
