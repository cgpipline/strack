...
class fillAppendDefaultFormulaUrlRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $authNode = [
            'name' => '获取用户列表',
            'code' => 'get_account_list',
            'lang' => 'Get_Account_List',
            'type' => 'route',
            'module' => 'page',
            'project_id' => 0,
            'module_id' => 0,
            'rules' => 'Admin/Account/getAccountList',
        ...
        $authNode = [
            'name' => '获取状态列表',
            'code' => 'get_status_list',
            'lang' => 'Get_Status_List',
            'type' => 'route',
            'module' => 'page',
            'project_id' => 0,
            'module_id' => 0,
            'rules' => 'Admin/Status/getStatusList',
            'uuid' => Webpatser\Uuid\Uuid::generate()->string
        ];
